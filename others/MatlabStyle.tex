...
% Matlab 代码环境
\newcommand{\Matlab}{\begin{lstlisting}[language=Matlab, deletekeywords={rand, disp, error, nargin, flipud, fliplr, plot, axis, hold, roots, linspace, figure, title, sign, find, zeros, fzero, exp, format, sin, cos, tan, cot, asin, acos, atan, real, imag, sum, mean, diff, floor, ceil, sinh, cosh, tanh, round, ans, size, randn, eye, magic}]}