...
Rayleigh-Ritz 方法是一种近似计算本征值问题的方法。 若要求 $N\times N$ \enref{厄米矩阵}{HerMat} $\mat A$ 的本征值和本征矢， 先把算符投影到由 $n < N$ 个正交归一基底 $\mat v_i$ 张成的子空间中。 若把每个列矢量 $\mat v_i$ 矩阵 $\mat V$， 那么子空间的投影矩阵就是
\begin{equation}
