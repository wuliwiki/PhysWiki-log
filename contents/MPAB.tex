...
\begin{table}[ht]
\centering
\caption{惯性系-非惯性系的伽利略变换}\label{MPAB_tab4}
\begin{tabular}{|c|c|}
\hline
物理量 & 公式 \\
\hline
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/MPAB_7.pdf}
\caption{在地面惯性系$K1$看来，板车以及车上的货物在向右加速，货物自然根据$\bvec F=m \bvec a$受到来自板车后侧的支持力；而在板车非惯性参考系$K2$看来，货物似乎被一个惯性力压在板车后方。这也是汽车加速时的“推背感”} \label{MPAB_fig7}
\end{figure}
