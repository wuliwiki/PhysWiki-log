...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/Vand_5.png}
...
\end{figure}
$A,B$ 对应温度 $T$ 下相变曲线两侧的液相和气相，相变发生的压强为 $P_A=P_B$。根据相变平衡条件\upref{PhEquv}，两点化学势应当相等，这也要求从 $A$ 沿着 $JDN$ 到 $B$ 过程中 $V\dd P$ 的积分为 $0$，这就意味着\autoref{Vand_fig2} 中两个阴影部分的面积相同。这就是\textbf{麦克斯韦等面积法则}。