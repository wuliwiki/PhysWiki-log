...
\pentry{相变平衡条件\upref{PhEquv}}
范德瓦尔斯方程描述的系统的等温线如下图：
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/f16c7cba32c8693a.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/53e3c805e5bcc876.png}
...
\pentry{热动平衡判据\upref{equcri}，亥姆霍兹自由能\upref{HelmF}，吉布斯自由能\upref{GibbsG}}
...
让我们进一步分析过热液体 $AJ$ 和过冷气体 $NB$ 的性质。虽然它们处于平衡稳定条件，但如果加以扰动，它们将迅速演变为气液共存态，落到 $ADB$ 水平线上。这是为什么呢？让我们研究这两个系统的某个热力学势，以亥姆霍兹自由能\upref{HelmF}为判据，对于\textbf{恒温恒容系统}，平衡稳定态的条件为
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/8dd54e1f2ea44271.png}
...
最后我们考察两相的化学势，即吉布斯自由能\upref{GibbsG}。利用 $\dd \mu=-S\dd T+V\dd P=V\dd P$ 得到等温线上对应的化学势变化曲线。如图

\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/291db2a86fd9f340.png}
\caption{化学势} \label{fig_Vand_3}
\end{figure}
$A,B$ 对应温度 $T$ 下相变曲线两侧的液相和气相，相变发生的压强为 $P_A=P_B$。根据相变平衡条件\upref{PhEquv}，两点化学势应当相等，这也要求从 $A$ 沿着 $JDN$ 到 $B$ 过程中 $V\dd P$ 的积分为 $0$，这就意味着\autoref{fig_Vand_2} 中两个阴影部分的面积相同。这就是\textbf{麦克斯韦等面积法则}。