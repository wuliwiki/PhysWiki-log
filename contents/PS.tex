...
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/f0d110a83118f7eb.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/2fadd4c4ae8cdcfc.png}
\caption{预处理 $2$ } \label{fig_PS_1}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/c6b14332626e87a1.png}
\caption{预处理 $3$} \label{fig_PS_3}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/81f09850677ac37d.png}
\caption{预处理 $4$} \label{fig_PS_4}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/d4782b96f149f89e.png}
\caption{预处理 $5$} \label{fig_PS_5}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/8c371d28ac03d439.png}
