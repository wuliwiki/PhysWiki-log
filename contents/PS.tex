...
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/PS_3.png}
\caption{预处理 $3$} \label{PS_fig3}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/PS_4.png}
\caption{预处理 $4$} \label{PS_fig4}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/PS_5.png}
\caption{预处理 $5$} \label{PS_fig5}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/PS_6.png}
