...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/PCuvMo_1.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/PCuvMo_2.png}
\caption{切向加速度与法向加速度} \label{PCuvMo_fig2}
\end{figure}
把速度矢量表示为大小和方向的标量积， 有 $\bvec v = v\uvec v$． 那么根据求导法则（\autoref{DerV_eq3}~\upref{DerV}），加速度可以被分解为相互垂直的两项：
