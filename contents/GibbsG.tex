...
\begin{issues}
\issueOther{建议创建单独的化学势文章}
\end{issues}

\pentry{热力学第二定律\nref{nod_Td2Law}}{nod_7c57}
...
\subsection{吉布斯能判据}
可以与\enref{亥姆霍兹自由能}{HelmF}类比，亥姆霍兹自由能所分析的系统是恒温的封闭系统。而此处，我们用吉布斯自由能分析\textbf{恒温恒压}下封闭的系统（封闭的意思是，没有物质进出于系统）。
...
由\enref{亥姆霍兹自由能判据}{HelmF}，得$\delta w \le -dA\Rightarrow \delta w \le -d(U-TS)~.$
