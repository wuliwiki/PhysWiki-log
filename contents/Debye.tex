...
\pentry{晶格热容的爱因斯坦理论\nref{nod_EScap}}{nod_8756}

根据量子理论，晶格的各个简谐振动模式的能量本征值都是量子化的，为
\begin{equation}
\qty(n_j+\frac{1}{2})\hbar \omega_j~.
\end{equation}
固体的一部分内能来自于晶格的振动，因此我们这里考虑的晶格热容就与这些简谐振动模式有关。我们需要知道晶格内能关于温度 $T$ 的函数，那么我们希望知道在特定温度下不同简谐振动模式的平均热能。根据\enref{玻尔兹曼分布}{MBsta}，能量本征值 $\epsilon$ 出现的概率与 $\E^{-\epsilon}$ 成正比，因此我们有
\begin{equation}
