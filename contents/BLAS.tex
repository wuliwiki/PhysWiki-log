...
我们这里介绍一个 cBLAS 的例子\footnote{要在 Linux 上编译， 见 “在 Linux 上编译第一个 C++ 程序\upref{linCpp}”}． 我们来测试矩阵和矢量的乘法函数 \lstinline|gemv|， 参考文档见\href{https://software.intel.com/en-us/node/834919#88940C4E-0889-46C3-B6CF-F8B6EA6CF4BC}{这里}．
...
级别(level)
\begin{enumerate}
    \item 向量与向量操作 (order $n$)
    \item 矩阵与向量操作 ( order $ n^2 $ )
    \item 矩阵与矩阵操作 ( order $ n^3 $ )
\end{enumerate}
