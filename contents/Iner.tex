...
若一个质点 $m$ 某时刻在惯性系 $xyz$ 中的加速度为 $\bvec a_{xyz}$， 在另一个非惯性系 $abc$ 中的加速度为 $\bvec a_{abc}$， 则可假设质点受到一个\bb{惯性力}
...
\end{equation}
即\bb{绝对加速度}\footnote{这里把绝对加速度定义为任意惯性系中的测得质点的加速度．由于不同惯性系之间的相对加速度为零，绝对加速度与惯性系的选择无关．}等于相对加速度加牵连加速度． 运用牛顿第二定律得质点真实的受力为（注意真实受力不随参考系变化）
