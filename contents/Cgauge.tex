...
当我们选择 $\lambda$ 使得 $\div \bvec A = 0$ 时，就得到了\textbf{库仑规范}． 这种选择在很多情况下可以简化计算，因为这样标势和矢势的麦克斯韦方程组（\autoref{EMPot_eq4}~\upref{EMPot} \autoref{EMPot_eq5}~\upref{EMPot}）化简为 （真空中的光速为 $c = 1/\sqrt{\mu_0\epsilon_0}$）%链接未完成
