...
当我们\enref{规范变换}{Gauge}中选择 $\lambda$ 使得 $\div \bvec A \equiv 0$ 时，就得到了\textbf{库仑规范}。 这种选择在很多情况下可以简化计算，因为这样标势和矢势的麦克斯韦方程组（\autoref{eq_EMPot_4}~\upref{EMPot} \autoref{eq_EMPot_5}~\upref{EMPot}）化简为 （真空中的光速为 $c = 1/\sqrt{\mu_0\epsilon_0}$）% \addTODO{链接}
...
\varphi \equiv 0~.
\end{equation}
结合\autoref{eq_EMPot_1}~\upref{EMPot}得到一个常用的结论是
