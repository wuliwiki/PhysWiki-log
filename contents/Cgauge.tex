...
当我们规范变换\upref{Gauge}中选择 $\lambda$ 使得 $\div \bvec A \equiv 0$ 时，就得到了\textbf{库仑规范}。 这种选择在很多情况下可以简化计算，因为这样标势和矢势的麦克斯韦方程组（\autoref{eq_EMPot_4}~\upref{EMPot} \autoref{eq_EMPot_5}~\upref{EMPot}）化简为 （真空中的光速为 $c = 1/\sqrt{\mu_0\epsilon_0}$）% \addTODO{链接}
...
\end{equation}
该方程若写成分量的形式就是常见的波动方程\upref{Wv2D}， 通解就是由任意极化方向 $\bvec A_0$ 和延传播方向 $\bvec k$ 光速传播的平面简谐波\upref{PWave}
\begin{equation}
