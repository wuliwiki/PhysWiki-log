...
\pentry{解三棱锥顶角\nref{nod_PrmSol}， 空间旋转矩阵\nref{nod_Rot3D}}{nod_e4b0}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/e04a8be20539536d.pdf}
\caption{足球透视图， 动画见\href{https://wuli.wiki/apps/football.html}{这里}， 代码见 “\enref{足球顶点坐标的计算程序（Matlab）}{foot60}”。} \label{fig_FootBl_1}
\end{figure}
...
\end{equation}
由\autoref{eq_PrmSol_2}~\upref{PrmSol}， 五边形与相邻棱的线面角满足 % \addTODO{添加“三棱锥公式”例2并引用}
\begin{equation}
...
\end{equation}
其中 $\bvec r_i$ 是第 $i$ 点的\enref{位置矢量}{Disp}。
...
% \addTODO{图，把图二左绕 z 轴旋转一下，使轮廓变为路线}

按照第一种路线到达顶部，转过的角度依次是 $\gamma, \gamma, \phi_{56}, \phi_{66}, \phi_{56}$。 可以验证，它们相加等于 $\pi$。% \addTODO{可以解析验证吗？}
