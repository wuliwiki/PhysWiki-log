...
\pentry{牛顿运动定律（高中）\upref{HSPM03}， 力的合成与分解\upref{Fdecom}， 速度的参考系变换\upref{Vtrans}}{nod_c316}
...
\subsection{第二定律}
\pentry{牛顿第二定律的矢量形式\upref{New2}}{nod_6e7d}
...
\subsubsection{动量定理}
牛顿本人对第二定律的表述使用了\textbf{动量定理}\upref{PLaw1}，记质点的动量为 $\bvec p$，则
