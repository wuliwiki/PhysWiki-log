...
\footnote{参考 \cite{GriffE} 以及 Wikipedia \href{https://en.wikipedia.org/wiki/Ampère's_circuital_law}{相关页面}。}静磁学问题% （链接未完成）
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/4998d8dea3224e61.pdf}
...
\end{equation}
这与使用比奥萨伐尔定律（\autoref{ex_BioSav_1}~\upref{BioSav}） 得出的结论一致。
\end{example}

\begin{example}{无限长螺线管的磁场}\label{ex_AmpLaw_2}
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/194d2ee0643b747d.pdf}
