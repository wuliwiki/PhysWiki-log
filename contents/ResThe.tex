...
\pentry{洛朗级数\upref{LaurSr}}{nod_a014}
...
\end{equation}
由\textbf{高斯积分}\upref{GsInt}的\autoref{eq_GsInt_1}~\upref{GsInt}，可知
\begin{equation}
...
\end{equation}
这和\textbf{高斯积分}\upref{GsInt}的\autoref{eq_GsInt_5}~\upref{GsInt}相符。
