...
对于任意逆时针环绕原点的路径 $P(t)$，我们可以求 $\int_{\Gamma}\frac{1}{z}\dd z-\int_{P}\frac{1}{z}\dd z$，其中 $\Gamma$ 完全包裹在 $P$ 中。这相当于求 $\Gamma$ 和 $P$ 之间区域的围道积分。这个中间区域是不包含原点的，因此由于 $1/z$ 在原点之外处处解析，由\enref{柯西积分定理}{CauGou}知，中间区域的围道积分为 $0$。从而我们可以推知，$\int_{P}\frac{1}{z}\dd z=2\pi\I$。
...
\begin{example}{}\label{ex_ResThe_2}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/5ffe2056a3f8881f.pdf}
...
\end{equation}
由\enref{高斯积分}{GsInt}的\autoref{eq_GsInt_1}~\upref{GsInt}，可知
\begin{equation}
...
\end{equation}
这和\enref{高斯积分}{GsInt}的\autoref{eq_GsInt_5}~\upref{GsInt}相符。
