...
\subsubsection{径向波函数}
球坐标系的薛定谔方程在分离变量后， 可得（约化）径向方程\autoref{RadSE_eq1}~\upref{RadSE}， 其中 $V(r) = -Z/r$。 对任意给定的 $E < 0$ 和 $l = 0,1,2,\dots$， 令 $\rho = \kappa r$， $\eta = -Z/\kappa$， $\kappa = \sqrt{-2mE}$， 径向方程化简为
\begin{equation}
...
\begin{equation}\label{HWF_eq7} % 已数值验证归一化和正交性
n = 1 \qquad
