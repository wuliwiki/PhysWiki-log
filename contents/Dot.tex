% 几何向量的点乘
% keys 线性代数|几何向量|dot product|点积|点乘|标量积|scalar product|内积|inner product|正交|归一化|正交归一基|交换律|分配律
% license Xiao
% type Tutor
...
% \end{equation}
% 根据分配律\autoref{eq_Dot_3}，我们可以把两个括号拆开，变为 4 个点乘之和。 
% \begin{equation}
...
% 注意虽然上式中的坐标取决于正交归一基底的选取， 但点乘的结果却与基底的选取无关。 这是因为点乘的几何定义是两个几何向量间的几何性质， 与基底无关。
