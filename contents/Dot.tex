...
我们说两个点乘为 0 的矢量互相\bb{正交}， 对于几何矢量， 正交与垂直没有区别． 几何矢量与自身点乘可得该矢量模长的平方． 我们把模长为 $1$ 的矢量称为\bb{单位矢量}， 单位矢量与自身点乘等于 $1$． 我们在矢量上面加上 “\^{}” 符号表示单位矢量， 如 $\uvec x$． 把一个矢量除以自身模长得到同方向单位矢量的过程叫做矢量的\bb{归一化}．
