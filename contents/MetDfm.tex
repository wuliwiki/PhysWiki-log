...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/MetDfm_2.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/MetDfm_5.pdf}
\caption{原子间作用力是吸引力与斥力的组合} \label{MetDfm_fig5}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/MetDfm_4.pdf}
\caption{原子间作用力示意图} \label{MetDfm_fig4}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/MetDfm_13.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/MetDfm_3.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/MetDfm_6.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=4cm]{./figures/MetDfm_10.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/MetDfm_7.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/MetDfm_14.pdf}
\caption{只有特定方向的分切应力（深红色）是有效的驱动力。} \label{MetDfm_fig14}
\end{figure}

即使位错大幅降低了滑移的难度，也得有足够大的力才能驱动位错运动。那么，全部外力都能驱动位错运动吗？遗憾的是，由于位错只在滑移系上运动，因此只有外力在\textbf{位错滑移方向与滑移面上的分力}才能驱动位错运动。\autoref{MetDfm_fig14} 简要地表述了这个现象。

\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/MetDfm_8.pdf}
\caption{进一步的分析} \label{MetDfm_fig8}
\end{figure}

为了更进一步地解决这个问题，我们建立一个更复杂的模型。如\autoref{MetDfm_fig8} 所示，我们假设滑移面是红色面，滑移方向是黑色线。那么，外力F在滑移方向上的分切应力为
\begin{equation}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/MetDfm_9.pdf}
\caption{晶体的各向异性示意图。由于两个物件内原子的排列方向不同，因此他们在塑性变形前所能承受的最大外力也不同。} \label{MetDfm_fig9}
\end{figure}
