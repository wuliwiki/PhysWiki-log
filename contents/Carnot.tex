...
\begin{figure}[ht]
\centering
\includegraphics[width=7cm]{./figures/f1d588a95704de87.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/0c86b576fece35b8.pdf}
\caption{卡诺循环的压强-体积图} \label{fig_Carnot_2}
\end{figure}
温度-熵\footnote{熵的宏观定义见\upref{Entrop}。}图，即 $T$-$S$ 图，则如下所示：
\begin{figure}[ht]
\centering
\includegraphics[width=6.5cm]{./figures/93d022497b3b677a.pdf}
