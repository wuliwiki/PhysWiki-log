...
\pentry{一维有限深方势阱\upref{FSW}， 四阶龙格库塔法（Matlab）\upref{OdeRK4}}

本文使用原子单位制\upref{AU}。 我们介绍用试射法解定态薛定谔方程（TISE， Time Independent Schrodinger Equation），其中 $V(x)$ 已知
\begin{equation}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/05cd72f56a3c19c6.pdf}
\caption{误差函数零点} \label{fig_BndSho_1}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/1f996d3a772649bc.pdf}
