...
\pentry{包络线\upref{Velope}，一阶隐式常微分方程\upref{ODEa4}}{nod_ff98}
...
这方法是常用的 $p$-判别曲线法，解题过程中使用的则是 $c$-判别曲线法，详见判别曲线法求一阶隐式常微分方程的奇解\upref{ODEa6}。方程出现奇解的原因则是违反了一阶隐式常微分方程的存在唯一性定理\upref{ODEa5}中的第三个要求。
