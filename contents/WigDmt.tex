...
\begin{equation}
\mathcal R\ket{l, m} = \sum_{m'} \mel{l, m'}{\mathcal R}{l, m} \ket{l, m'}
\end{equation}
...
\subsection{表达式}
一种定义旋转的方法就是利用三个欧拉角表示旋转， 即先将 $\ket{l, m}$ 绕 $z$ 轴逆时针旋转 $\gamma$ 角， 再绕 $y$ 轴逆时针旋转 $\beta$ 角， 最后绕 $z$ 轴旋转 $\alpha$ 角． 我们将旋转算符记为 $\mathcal R(\alpha, \beta, \gamma)$． 由球谐函数的定义\autoref{SphHar_eq1}\upref{SphHar}， 第一个旋转得到 $\exp(-\I m \gamma)\ket{l, m}$．
