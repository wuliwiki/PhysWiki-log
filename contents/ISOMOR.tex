...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/0e2f6c33aad3ac8a.pdf}
\caption{典型的匀晶系合金相图，以$Ni-Cu$系统为例。本图仅作示例，未按实际比例绘制。固相区的相变已略去。数据来源：唐仁政，二元合金相图} \label{fig_ISOMOR_1}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/8f15800090aca003.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7cm]{./figures/1fb5ac4d790ad045.pdf}
