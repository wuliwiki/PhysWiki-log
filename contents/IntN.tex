...
\subsection{面积分}
\bb{面积分} 也叫\bb{二重积分}， 可以看做一元函数定积分\upref{DefInt} 的一种拓展． 从几何上来理解， 如果后者是计算一定区间内被积函数曲线与坐标轴之间的面积， 那么前者就是计算一定二维区域内被积函数曲面与坐标轴平面之间的体积．
...
\end{equation}
这是一个\bb{双重极限}， 类比定积分的定义， 用面积分简写上式记为
\begin{equation}
...
\subsection{体积分}
\bb{体积分}也叫\bb{三重积分}， 类比面积分不难理解其概念
