...
在柱坐标和球坐标下，函数 $f(x,y,z)$ 变为 $f(r,\theta,z)$ 和 $f(r,\theta,\phi)$，而体积元 $\dd x\dd y\dd z$ 变为 $r\dd r\dd\theta\dd z$ \autoref{eq_CrIntN_1} 和 $r^2\sin\theta\dd r\dd\theta\dd\phi$ \autoref{eq_CrIntN_3} .故三重积分\autoref{eq_IntN_2} 在柱坐标和球坐标下分别表示为
\begin{equation}
