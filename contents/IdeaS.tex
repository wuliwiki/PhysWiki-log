...
\end{equation}
不考虑位置的话，原子的动量可以取满足 \autoref{IdeaS_eq1} 的任意值，所以我们必须看看满足条件的动量值有多少个。我们将该条件改写为
\begin{equation}
...
\end{equation}
这样，从玻尔兹曼熵公式我们可以得到理想气体状态方程，并且我们注意到前面的推导过程中未曾利用温度 $T$ 的概念，因此玻尔兹曼熵公式给出了温度的统计力学定义（温度、温标 \autoref{tmp_eq1}~\upref{tmp}）。