...
\vskip-10pt
\centering
\includegraphics[width=9.5cm]{./figures/CrossP.pdf}
...
由于 $\vec B',\vec C',\vec D'$ 都与 $\vec A$ 垂直，所以 $\vec A$ 与之叉乘的效果相当于 $\vec B',\vec C',\vec D'$ 的模长分别乘以 $\abs {\vec A} $， 且绕 $\vec A$ 逆时针分别旋转 $90°$． 所以上式就是在说，“ $\vec D'$乘以 $\abs {\vec A} $ 旋转90°”和“ $\vec B'$ 与 $\vec C'$ 分别乘以 $\abs {\vec A} $ 旋转90°再相加”结果相同，而这显然成立．\\
证毕．
