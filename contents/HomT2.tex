...
\pentry{同伦\upref{HomT1}}{nod_a243}
%未完待续
...
从\textbf{映射的同伦和空间的同伦}\upref{HomT1}词条的\autoref{exe_HomT1_1} 可知，同伦意味着映射的每个点都画出一条道路，或者说连续移动。因此，如果 $X$ 有一个到 $A$ 的形变收缩，那么 $X$ 中的所有点都可以同时、连续地移动到 $A$ 当中。
