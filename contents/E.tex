...
我们把以 $\E$ 为底的对数函数 $\log_e x$ 叫做\textbf{自然对数函数}， 记为 $\ln x$ 或者直接用 $\log x$。 % \addTODO{链接}
...
\textbf{拓展知识}： 以后在\enref{泰勒展开}{Taylor}中会看到
\begin{equation}
...
也可以用 \autoref{tab_E_1} 数值计算验证\autoref{eq_E_1} 中的 $n\to+\infty$ 极限。
\begin{table}[ht]
\centering
