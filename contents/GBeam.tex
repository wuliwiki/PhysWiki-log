...
\end{equation}
这就是著名的柯林斯(Collins)公式。这里一维到二维的转换可能难以理解，该公式的详细推导可以自行查阅。可以简单进行一下验证。真空其实是玻璃的“一种”，其折射率为1，那么它的ABCD矩阵也就是：
\begin{equation}
\pmat{1&L\\0&1}~.
\end{equation}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/3d0b8ea59c1ef81a.png}
