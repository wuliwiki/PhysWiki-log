% 集合
% keys 朴素集合论|元素|子集|并集|交集|补集|可数|不可数
% license Xiao
% type Tutor

\pentry{集合（高中）\nref{nod_HsSet}}{nod_19d2}

\subsection{集合}

对于非数学专业学习而言，集合论没必要从公理角度来严格理解，所以在此不会给出用于划定集合论讨论范围的\enref{公理系统}{axioms}，而是\textbf{朴素集合论（naive set theory）}的解释，即比较接近自然语言的表达方式。
...
\begin{definition}{幂集}\label{def_Set_1}
