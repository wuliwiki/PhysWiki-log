...
\subsection{精确定义的常数}
\footnote{本文参考 Wikipedia \href{https://en.wikipedia.org/wiki/Physical_constant}{相关页面}， 以及 NIST 的 2018 CODATA \href{https://physics.nist.gov/cuu/Constants/Table/allascii.txt}{常数表}。}2019 年 5 月 20 日生效的国际单位制\upref{SIunit}中精确定义了 7 个基本常数的数值和\textbf{基本单位（SI base units）}， 每个基本单位的大小都可以由这些常数的定义测量出来。
...
\end{equation}
其中法拉是电容单位 $\Si{F} =\Si{\frac{C^2}{N m}} = \Si{s^4 m^{-2} kg^{-1} A^2}$。 相关文章： 电容\upref{Cpctor}。
