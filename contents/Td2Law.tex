...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/0267d1d4eb342765.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/5a1782a4a3046c83.png}
...
基于平衡判据与数学推导，我们发现平衡的孤立系统中温度、压强与化学势（如果你还不知道什么是化学势，不用担心，你以后会知道的）处处相同，此谓\enref{热动平衡判据}{equcri} 。具体的推导参考“\enref{热动平衡判据}{equcri}” 与“\enref{相变平衡条件}{PhEquv} ”。
$$
...
\textsl{太长不看}：\enref{亥姆霍兹自由能}{HelmF}与\enref{吉布斯自由能}{GibbsG} 。
...
也就是说，如果某个过程后$\Delta F < 0$，那么它可以发生。这就是\enref{亥姆霍兹自由能}{HelmF} 与 亥姆霍兹判据。可见，对于非绝热系统，尽管系统自身的熵可以降低，但是系统和环境一起的“大系统”的总熵必须增加。

类似地，对于等温等压系统，我们有\enref{吉布斯自由能}{GibbsG} 与相应的Gibbs判据。

\subsubsection{热二与系统做功能力}
接下来，我们探讨热二如何影响系统的做功能力。我们假定一个封闭等温等容的系统。根据\enref{热一}{Th1Law} 的能量守恒，我们有
...
且由此我们可以知道孤立系统处于平衡态时它的熵一定是处于极大值的，否则系统就会自发地朝熵增大的方向演化。这就是孤立系统处于平衡态的熵判据，具体内容可以参考\enref{热动平衡判据}{equcri}文章。
