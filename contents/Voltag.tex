...
\begin{equation}
\mathscr{C}=-\frac{\mathrm{d} \Phi}{\mathrm{d} t}=-\frac{\mathrm{d}}{\mathrm{d} t} \iint_{(S)} \boldsymbol{B} \cdot \mathrm{d} \boldsymbol{S}=-\frac{\mathrm{d}}{\mathrm{d} t} \oint_{(L)} \boldsymbol{A} \cdot \mathrm{d} \boldsymbol{l}=-\oint_{(L)} \frac{\partial \boldsymbol{A}}{\partial t} \cdot \mathrm{d} \boldsymbol{l}~.
\end{equation}
