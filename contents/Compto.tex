% Compton 散射
% keys 康普顿散射|Compton|Klein-Nishina 公式|散射截面|量子电动力学
% license Xiao
% type Tutor
...
this process is related to  $e^+e^-\rightarrow \gamma\gamma$（\enref{Bhabha 散射}{Bhabha}） by crossing symmetry, so we can simply do variable replacements:
\[
