...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/2d0c412aa38f4b2c.png}
\caption{外反射： $r$、$t$ 作为入射角的函数} \label{fig_PhaSft_3}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=13cm]{./figures/9e012e8d8ec6a7fb.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=13cm]{./figures/0c33d6df47bf226d.png}
