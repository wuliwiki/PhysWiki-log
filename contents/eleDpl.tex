...
\pentry{电势 电势能\upref{QEng}}{nod_4267}
...
令空间中两个位置不同的点电荷具有等量的异号电荷， 则他们构成一对\textbf{物理电偶极子}，令他们的电荷量分别为 $-q$ 和 $q$ ， 位置矢量分别为 $\bvec r_1$ 和 $\bvec r_2$， 则它们的总电场为两个电荷各自电场的矢量和（见\autoref{eq_Efield_2}~\upref{Efield}）
...
\end{equation}
总电势同样是两个点电荷的电势之和，这是因为电势是可以线性叠加的。(见电势、电势能\upref{QEng})
...
理想电偶极子的电场，或者物理电偶极子在远处的电场，可以通过求电势的梯度来得到。引用\autoref{eq_VecAnl_15}~\upref{VecAnl}，令 $\bvec{a}=\bvec{p}$ 为常量，$\bvec{b}=\bvec{r}/r^3$， 则有：
