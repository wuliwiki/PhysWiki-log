...
\begin{figure}[ht]
\centering
\includegraphics[width=4cm]{./figures/eleDpl_1.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/eleDpl_3.png}
\caption{理想电偶极子的电场与等势面示意图} \label{eleDpl_fig3}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/eleDpl_4.png}
...
理想电偶极子的电场，或者物理电偶极子在远处的电场，可以通过求电势的梯度来得到。引用\autoref{VecAnl_eq15}~\upref{VecAnl}，令 $\bvec{a}=\bvec{p}$ 为常量，$\bvec{b}=\bvec{r}/r^3$， 则有：
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/eleDpl_2.pdf}
