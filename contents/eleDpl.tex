...
&=\frac{1}{4\pi\epsilon_0}\frac{1}{r^3}\pmat{
    -p_x\frac{r^2-3x^2}{r}+p_y\frac{-3xy}{r}+p_z\frac{-3xz}{r}\\
    p_x\frac{-3xy}{r}-p_y\frac{r^2-3y^2}{r}+p_z\frac{-3yz}{r}\\
    p_y\frac{-3xz}{r}+p_y\frac{-3yz}{r}-p_z\frac{r^2-3z^2}{r})
    }
&=\frac{1}{4\pi\epsilon_0}\frac{1}{r^3}\pmat{
    -p_x\frac{r^2-3x^2}{r^2}+p_y\frac{-3xy}{r^2}+p_z\frac{-3xz}{r^2}\\
    p_x\frac{-3xy}{r^2}-p_y\frac{r^2-3y^2}{r^2}+p_z\frac{-3yz}{r^2}\\
    p_y\frac{-3xz}{r^2}+p_y\frac{-3yz}{r^2}-p_z\frac{r^2-3z^2}{r^2})
    }
\end{aligned}
\end{equation}
