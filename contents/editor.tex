...
\item 我们在模板中加入了许多自定义命令， 但不会影响 LaTeX 原有的命令
...
\caption{从 \link{littleshi.cn/online}{http://littleshi.cn/online} 查看编辑中的词条} \label{editor_fig1}
\end{figure}
