...
\pentry{球谐函数\upref{SphHar}， 径向函数的归一化\upref{FrNorm}}{nod_5cf3}
...
\pentry{多元傅里叶变换\upref{NFTran}}{nod_f10e}
...
\end{equation}
由于第二类球贝塞尔函数\upref{SphBsl} $y_l(kr)$ 在 $r\to 0$ 时有奇点， 所以 $B_{l,m} = 0$。 而第一类球贝塞尔函数 $j_l$ 在 $r\to \infty$ 时有渐进形式（\autoref{eq_SphBsl_2}~\upref{SphBsl}）
\begin{equation}
