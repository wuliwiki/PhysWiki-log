...
高斯定义
\begin{equation}
\Gamma(z):=\lim_{n \rightarrow ∞}{\frac{n!n^z}{z(z+1)⋯ (z+n)}}=\prod_{n}^{∞}\frac{\left( 1+\frac1n \right)^z}{\left( 1+\frac zn \right)}
\end{equation}
魏尔斯特拉斯定义
\begin{equation}
...
所以有
\begin{equation}
\sin nz=n(\cos^{n-1}z)\sin z-\frac{n(n-1)(n-2)}{1· 2·3}(\cos^{n-3}z · \sin z)+⋯
\end{equation}
...
考虑到在 $z_m=\frac{mπ}{2k+1}\,,m=1,2,\dots,k $时， 对于每一个 $z_m$ ，都有$ \sin(2k+1)z=0,\sin\,z\ne 0$
...
则有
\begin{equation}
\sin^2\frac {h\pi}{2k+1}>\frac4\pi\frac{(h\pi)^2}{(2k+1)^2}，h=a+1,\dotsk 
\end{equation}
...
\begin{lemma}{}
对于充分大的n而言，$\prod_{n=1}^{∞}(1+a_n) $收敛的充要条件是  $\sum_{n=1}^{∞}{a_n}$ 收敛．
\end{lemma}
