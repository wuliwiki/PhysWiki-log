...
\subsection{质心与重心}
质心在物理中有什么用呢？ 一个基本的应用就是质心就是物体的\textbf{重心}． 我们只讨论均匀引力场中物体的重心． 其定义是： 若重力场对物体关于某点的合力矩恒为 0， 这个点就是它的\textbf{重心}． “合力矩为零” 意味着， 如果物体初始时以任意姿态静止， 那么它将一直保持静止． 虽然我们还没系统学习力矩， 但可以用初中学过的 “力乘力臂” 进行计算（\autoref{Torque_eq2}\upref{Torque}）．

\begin{example}{}\label{CM_ex1}
\begin{figure}[ht]
\centering
\includegraphics[width=5.5cm]{./figures/CM_1.png}
