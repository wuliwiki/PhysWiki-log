...
\textbf{重心的定义}是： 若重力场对物体关于某点的\enref{合力矩}{Torque}恒为 0， 这个点就是它的\textbf{重心}。 合力矩为零意味着， 如果物体初始时以任意姿态静止， 那么它将一直保持静止。 虽然我们还没系统学习力矩， 但可以用初中学过的 “力乘力臂” 进行计算（\autoref{eq_Torque_2}）。
