...
\subsection{质心的定义}
\textbf{质心（center of mass）}通俗来讲可以理解为质量的中心， 是系统中位置矢量\upref{Disp}关于质量的加权平均值． 我们先看几个例子．

\begin{example}{两个等质量质点的质心}

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/CM_4.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/CM_5.pdf}
