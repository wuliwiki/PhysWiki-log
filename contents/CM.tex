...
\subsection{质心的定义}
\textbf{质心（center of mass）}通俗来讲可以理解为质量的中心， 是系统中位置矢量\upref{Disp}关于质量的加权平均值． 我们先看几个例子． 注意本文主要是讨论质心的\textbf{定义}， 至于为什么要这么定义， 以及质心、中心、物体受力平衡之间的联系则留到以后（\autoref{CM_ex1} 给出了一个初步的思考）．

\begin{example}{两个等质量质点的质心}

\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/CM_4.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/CM_5.pdf}
...
\subsection{质心的分解}\label{CM_sub1}
...
\begin{figure}[ht]
\centering
\includegraphics[width=2.5cm]{./figures/CM_2.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=3cm]{./figures/CM_3.pdf}
...
\textbf{重心的定义}是： 若重力场对物体关于某点的合力矩\upref{Torque}恒为 0， 这个点就是它的\textbf{重心}． 合力矩为零意味着， 如果物体初始时以任意姿态静止， 那么它将一直保持静止． 虽然我们还没系统学习力矩， 但可以用初中学过的 “力乘力臂” 进行计算（\autoref{Torque_eq2}~\upref{Torque}）．
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/CM_1.pdf}
