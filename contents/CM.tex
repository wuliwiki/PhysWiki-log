...
\subsection{质心的定义}
\textbf{质心（center of mass）}通俗来讲可以理解为质量的中心， 是系统中各个质点的位置矢量\upref{Disp}关于质量的加权平均值． 我们先看几个例子．
...
\end{figure}
边长为 $2L$ 的大正方形和边长为 $L$ 的小正方形拼接在一起， 假设密度均匀， 求拼接后物体的质心（提示：可以分别求出两正方形的质心在求 “质心的质心”）．
\end{exercise}
