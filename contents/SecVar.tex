...
\pentry{变分\upref{Varia}}{nod_1920}
...
应用泰勒公式并引用符号\autoref{eq_Varia_6}~\upref{Varia}
\begin{equation}
...
\end{aligned}
\end{equation}
其中， $\tilde{F}_{yy}=F_{yy}(x,y+\theta_1\delta y,y'+\theta_2\delta y'),\;(\abs{\theta_1},\abs{\theta_2}\leq1)$，$\tilde{F}_{yy},F_{yy'},F_{y'y'}$ 类似。由于 $F$ 对其变量二阶连续，当一级距离\autoref{def_AbPol_1}~\upref{AbPol} $r(\overline{y},y)$ 充分小时，就有
\begin{equation}
