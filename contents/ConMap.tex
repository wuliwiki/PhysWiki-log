...
\pentry{完备度量空间\upref{cauchy}，压缩映射\upref{ComMap}}{nod_46d2}
...
设 $(X,d)$ 是完备度量空间\upref{cauchy}, $T:X\to X$ 是其上的压缩映射\upref{ComMap}， 那么映射 $T$ 有唯一的不动点， 即满足 $x=Tx$ 的点。 而且， 对于任意 $x_0\in X$, 点列 $\{T^nx_0\}_{n\in\mathbb{N}}$ 都收敛到这个不动点。
\end{theorem}
