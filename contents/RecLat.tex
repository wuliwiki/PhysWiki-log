...
\end{equation}
其中，$d$ 是相邻\enref{晶面}{CryDir}的距离，$n$是整数，$\theta$是入射波与晶面夹角。
\begin{figure}[ht]
\centering
...
如图，红色圆点代表不同\enref{原胞}{BraLat}内的原子，蓝线分别代表入射波$\bvec k$和出射波$\bvec k'$，格矢$\bvec R$ 是两个原胞之间的距离。发生弹性散射后得到的出射光与入射光频率相同，方向发生改变。
