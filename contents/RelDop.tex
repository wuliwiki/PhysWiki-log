...
取 $K_1$ 中光的两个相邻的波峰\footnote{也可以是相邻波谷，或者任何相邻的两个同相位的点。}，作为两个以光速运动的点。为简化讨论，不妨设其中一个点的世界线\footnote{见\textbf{时空的四维表示}\upref{SR4Rep}或\textbf{世界线和固有时}\upref{wdline}。}表示为
\begin{equation}
\pmat{t_1\\t_1\\0\\0}~,
\end{equation}
而另一个点为
...
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/5f6964b55497af98.png}
