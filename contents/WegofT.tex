...
\subsection{外积}
事实上，基于\enref{张量的对称化和交错化}{SIofTe}引文处提到的理由，讨论任意张量的对称性和斜对称性，与 $(0,p)$型或 $(p,0)$ 型没有任何区别。为了多样性起见，这里考虑 $(0,p)$ ，即取空间（$\Lambda^p(V)$ 的定义可见\autoref{def_SIofTe_2}~\upref{SIofTe}后的段落。） 
