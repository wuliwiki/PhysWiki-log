...
接下来证明$\mathbb{K}/\mathbb{S}$是可分扩张，只考虑$\opn{ch}\mathbb{F}$是素数$p$的情况，因为特征为$0$的域必是完美域\footnote{见\enref{可分扩张}{SprbEx}。}。
...
% 由\autoref{the_SprbEx_5}，完美域的代数扩张全都是可分扩张，从而由\autoref{def_PInsEx_2} 直接得证。
