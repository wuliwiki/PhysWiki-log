...
\begin{example}{}
在区间 $[0, \infty)$ 上， 令函数 $f(x) = x^2$， 那么反函数为 $f^{-1}(x) = \sqrt{x}$． 已知 $f'(x) = 2x$ （\autoref{FunDer_eq2}~\upref{FunDer}）， 带入\autoref{InvDer_eq3} 得反函数的导数为
\begin{equation}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/InvDer_1.pdf}
