% 矢量叉乘
% keys 线性代数|矢量|叉乘|cross product|叉积|cross product|向量积|vector product|矢量积|分配率
% license Xiao
% type Tutor

\pentry{三阶行列式\upref{Deter} }{nod_8777}

矢量叉乘在物理定律中十分常见， 例如在讨论力学中的力矩\upref{Torque}， 角动量\upref{AngMom}， 以及电磁学中的洛伦兹力\upref{Lorenz}， 安培力\upref{FAmp}时都会使用。 以下我们讨论的矢量都是\textbf{三维空间}中的几何矢量\upref{GVec}， 在讨论它们的坐标时， 我们默认取正交归一基底。
