...
一个系统所处的\textbf{量子态}是\enref{复希尔伯特空间}{Hilber}上的一个矢量，用\textbf{狄拉克符号}\footnote{见\enref{狄拉克符号}{braket}或\textbf{对偶空间}\autoref{sub_DualSp_1}。}表示。
...
Jacobi恒等式建议自行证明，也可直接参考\enref{李代数}{LieAlg}文章中李代数的定义（要求Jacobi恒等式成立）以及\autoref{the_LieAlg_2} （该定理适用于对易子）。
