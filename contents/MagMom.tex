...
\pentry{力矩\upref{Torque}， 安培力\upref{FAmp}}{nod_67ba}
...
为了更好地表示这个结果， 定义\textbf{磁矩（magnetic moment）}\footnote{也叫\textbf{磁偶极子}， 见“磁多极矩\upref{edy33}”。}为
...
\end{equation}
事实上， 可以证明这个结论与线圈的形状无关， 线圈甚至可以不在同一个平面上（此时需要重新定义 $\bvec A$）， 详见 “磁场中闭合电流的力矩\upref{EBTorq}”。 另外， 当我们由多匝线圈时， 只需将结果乘以匝数即可。
