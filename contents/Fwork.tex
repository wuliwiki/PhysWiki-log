% 功、功率
% keys 做功|功率|能量|位移|曲线积分
% license Xiao
% type Tutor

\pentry{矢量的内积\nref{nod_Dot}，定积分\nref{nod_DefInt}}{nod_36f5}

\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/55b4f4e72e7dcee8.pdf}
...
\end{equation} 
事实上，当曲线分割的越细，即 $n$ 越大时，上式就越精确地成立。类比\enref{定积分}{DefInt}中的介绍，令 $n \to \infty $， 把求和符号换成积分符号，把表示增量的 $\Delta $ 换成微分符号 $\dd{}$， 则不等号可以变为等号。
...
\end{equation} 
不同于一元函数的积分，这一类特殊的积分叫做\textbf{线积分}，详见“\enref{线积分}{IntL}”。
