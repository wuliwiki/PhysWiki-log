...
我们定义矩阵\upref{Mat}的\textbf{列秩（column rank）}等于其线性无关\upref{linDpe}的列数， \textbf{行秩（row rank）}等于线性无关的行数． 以后我们会证明任意的矩阵的行秩和列秩是相同的\upref{RCrank}， 所以都可以直接叫做矩阵的\textbf{秩（rank）}．
