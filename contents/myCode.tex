...
网页版百科分为两个界面：\textbf{原界面} \verb|wuli.wiki/online| 由静态 html 网页构成，每个文章的网址如 \verb|wuli.wiki/online/AU.html| 其中 AU 是文章的 id， 每个文章都有唯一的 id， 即使文章被重命名也不会变。  \textbf{新界面} \verb|wuli.wiki/book| 相当于在原界面上套壳，每天准点爬取 \verb|wuli.wiki/online/| 中的内容进行更新， 增加了评论，搜索等功能， 目录也更美观。 新界面中文章的网址如 \verb|wuli.wiki/book/AU|。
