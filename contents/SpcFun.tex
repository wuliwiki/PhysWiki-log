...
最常见的展开有三种， 分别是泰勒展开， 渐进展开， 以及连续分数． 这些展开在 \link{functions.wolfram.com}{http://functions.wolfram.com} 都可以找到．
...
另外两种不明觉厉的算法分别是\bb{切比雪夫多项式（Chebyshev Polynomial）}和\bb{算数几何平均（Agorithmic-Geometric Mean, AGM}， 后者也通常被用于计算高精度的 $\pi$， 且有二次收敛．
