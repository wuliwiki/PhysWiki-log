...
\pentry{不定积分\upref{Int}}\pentry{复数\upref{CplxNo}}
...
$\begin{eqnarray*} LHS&=&a^2\int \sec^3\theta\,\mathrm{d}\theta\\ &=&\frac{a^2}{2}\tan\theta\sec\theta+\frac{a^2}{2}\ln\left|\tan\left(\frac{\theta}{2}+\frac{\pi}{4}\right)\right|+C\\ &=&\frac{1}{2}\left(x\sqrt{x^2+a^2}+a^2\ln\left|x+\sqrt{x^2+a^2}\right|\right)+C \end{eqnarray*}$ 
\end{example}
