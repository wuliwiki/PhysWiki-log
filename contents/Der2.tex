% 导数（数学分析）
% keys derivative|微分|differential|斜率|切线|导函数|函数|function|微积分|calculus|数学分析
% license Xiao
% type Tutor

\pentry{极限\nref{nod_Lim}}{nod_cadc}



切线的几何描述并不严谨和完整，初学者可能会有很多疑问，比如割线的两个点靠近切点的时候，如果其中一个点到切点的距离始终是另一个点到切点距离的两倍，那它们还算同时达到切点吗？

实际上，在\enref{极限}{Lim}中我们强调过，极限的概念并不是简单地等同，而是趋近的性质。用割线去接近切线也是一种极限，不存在“达到切点”的情况，只能是越来越接近切点。
