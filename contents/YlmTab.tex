...
\pentry{球谐函数\upref{SphHar}}{nod_3104}

下面列出一些常见的球谐函数， 这和 Mathematica 和 Wolfram Alpha 的定义\footnote{例子： 在 \href{https://www.wolframalpha.com/}{wolframalpha.com} 中输入 \lstinline|SphericalHarmonics[2,1]|， 或者在 Mathematica\upref{Mma} 中输入 \lstinline|SphericalHarmonicY[2, 1, θ, ϕ]|} 一致。 Condon–Shortley 相位（\autoref{sub_SphHar_1}~\upref{SphHar}） 体现在对于奇数 $m$ 的球谐函数表达式前的 $\mp$ 号。
