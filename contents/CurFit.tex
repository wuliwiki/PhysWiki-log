...
我们在 “最小二乘法\upref{LstSqr}” 见到的三个例子中， 方差函数都是待定系数的线性组合， 这种情况下我们令偏导为零后得到的是线性方程组， 便于求解 %（见 Matlab 或 Mathematica）\addTODO{链接} 
...
\caption{高斯函数\upref{GausPD} $A\exp[-(x-x_m)^2/(2\sigma^2)]$ 的拟合（\verb|fit_gaussian_test.m|）} \label{fig_CurFit_2}
\end{figure}
