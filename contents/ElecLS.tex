...
% license Xiao
% type Tutor
\pentry{拉格朗日电磁势\nref{nod_EMLagP}，电磁场张量\nref{nod_EMFT}}{nod_ce6e}
...
现在考虑带电粒子的拉氏量。根据\enref{拉格朗日电磁势}{EMLagP}中的证明，带电粒子在电磁场中的广义势为 $U=q(\phi-\bvec A\cdot \bvec v)$，根据 $L=T-U$，可以给\autoref{eq_ElecLS_1} 增添一项，得到带电粒子的拉氏量
...
上面的推导多次用了分部积分。我们定义\enref{电磁场张量}{EMFT} $F_{\mu\nu}=\partial_{\mu}A_\nu-\partial_\nu A_\mu$，那么
\begin{equation}
