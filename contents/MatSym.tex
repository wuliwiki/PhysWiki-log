% Matlab 符号计算和变精度计算
% 符号计算|Matlab|变精度计算|任意精度计算|求导|积分|特殊函数
...
\item 猜测功能会忽略双精度最后几位的误差， 例如 \verb|vpa(1+1e-14)| 得 \verb|1.0|， \verb|sym(vpa(1+1e-14))| 得 \verb|1|． \verb|sym(pi+1e-14)| 得 \verb|pi|． 这有时候可能反而会造成麻烦．
