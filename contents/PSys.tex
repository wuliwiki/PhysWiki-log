% 质点系
% keys 质点|牛顿第三定律|合外力|内力
% license Xiao
% type Tutor

\pentry{牛顿第三定律\nref{nod_New3}}{nod_f1ae}
\begin{figure}[ht]
\centering
...
\end{equation}
任意两个质点 $k$ 和 $l$ 对该求和的贡献是一对相互作用力 $\bvec F_{k \to l} + \bvec F_{l \to k}$，而根据\enref{牛顿第三定律}{New3}，相互作用力之和为零。所以上式求和为零。 所以， 质点系中\textbf{合内力为零}， 系统所受合力等于合外力
\begin{equation}
