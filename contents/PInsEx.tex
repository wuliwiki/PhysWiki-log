...
设$\mathbb{S}$是$\mathbb{F}(\alpha)$上$\mathbb{F}$的可分闭包．由可分元的封闭性（\autoref{SprbE2_cor4}~\upref{SprbE2}）可知，可分元必是可分元运算所得结果．又考虑到$\mathbb{S}$的元素都是由各$\alpha_i$组合而来，又不能包含不可分元素，于是
