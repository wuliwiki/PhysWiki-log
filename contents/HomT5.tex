...
Seifert-van Kampen定理难以简洁表达，不过如果能充分理解\enref{群的自由积}{FrePrd}，应该容易理解该定理。不过，我们可以考虑该定理的弱化版本，此版本用处也很广泛：
...
除此之外，我们在\enref{可缩空间}{HomT2}中提到的形变收缩也能用于大大简化基本群的计算。
...
% \caption{从射影平面中间挖去一个洞得到莫比乌斯带示意图。详见\textbf{商拓扑}\upref{Topo7}文章。} \label{fig_HomT5_9}
% \end{figure}
