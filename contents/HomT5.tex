...
设拓扑空间 $X$ 可以被它的两个开集 $U_1$ 和 $U_2$ 覆盖，并且 $U_1\cap U_2$ 是单连通的\autoref{SmpCn_def1}~\upref{SmpCn}，那么有 $\pi_1(X)=\pi_1(U_1)*\pi_1(U_2)$．
\end{theorem}
...
理解莫比乌斯带基本群的难点是看出中轴线是其强形变收缩核，为了方便描述如何构造对应的强形变收缩，我们把莫比乌斯带看成射影平面挖去中心的结果，如%\autoref{HomT5_fig9}
所示．
