...
\end{definition}
根据\autoref{DerDir_eq7}~\upref{DerDir}， 驻点处各个方向的方向导数\upref{DerDir}也都为零。
\begin{equation}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/F2Exm_1.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/F2Exm_2.png}
