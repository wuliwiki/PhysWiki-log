...
\pentry{电磁场标势和矢势\upref{EMPot}}{nod_4d5d}
...
\end{equation}
但如果 $\lambda$ 随时间变化，\autoref{eq_EMPot_1}~\upref{EMPot} 中的电场会改变。 因此我们需要同时修正 $\varphi$， 才能确保变换后电场也不改变。 可以发现只需要令 $\varphi' = \varphi - \pdv*{\lambda}{t}$ 即可
\begin{equation}
