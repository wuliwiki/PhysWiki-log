% 比奥萨伐尔定律
% keys 磁场|比奥萨法尔|毕奥萨法尔|电流|导线
% license Xiao
% type Tutor
\pentry{电流产生磁场\nref{nod_CurMag}， 电流密度\nref{nod_Idens}， 矢量叉乘\nref{nod_Cross}， 线积分\nref{nod_IntL}}{nod_4ad9}

\subsection{闭合回路的磁场}
若已知空间中的电流分布， \textbf{比奥萨伐尔定律（Biot–Savart law）}给出了这些电流产生的磁场。 我们先讨论一种较为简单的情况， 即一根粗细可忽略的闭合导线中的恒定电流产生的磁场\footnote{在电动力学\upref{EM0}中， 我们提到不存在瞬间作用， 电磁场的传播需要时间。 而且变化的磁场也会产生变化的电场， 这将使计算变得十分复杂， 我们将在 “推迟势\upref{RetPot}” 中介绍。}。 假设导线中电流为 $I$， 空间中任意位置 $\bvec r$ 的磁场可以用线积分表示为
...
比奥萨伐尔定律精确符合麦克斯韦方程组\upref{MWEq}， 不存在近似。
