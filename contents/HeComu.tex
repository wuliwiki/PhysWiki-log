...
另外容易证明宇称算符 $\Pi$ 和 $H$ 对易， 和 $L^2$、$L_z$ 也对易（用\autoref{GenYlm_eq2}~\upref{GenYlm}\autoref{GenYlm_eq6}~\upref{GenYlm}）。 所以 $H,L^2,L_z,\Pi$ 两两对易。 最后还可以加上粒子交换算符 $P_{12}$， 得到 $H,L^2,L_z,\Pi, P_{12}$ 两两对易。 单自旋态的氦原子的空间波函数满足交换对称， 三重态自旋满足交换反对称。 这样就可以写出氦原子束缚态的能项符号（$M=0$）
\begin{equation}
n^{2S+1}L^{o/e}
\end{equation}
