...
\subsubsection{具体计算}
在 $S$ 中，根据高斯定理\autoref{EGauss_ex1}~\upref{EGauss}，一个无限长直导线会产生径向方向的电场，其大小与距直导线的距离 $r_0$ 成反比，即 $E_z=\lambda/(2\pi\epsilon_0r_0)$．由于 $S$ 参考系中直导线上的电荷静止，不会产生磁场，所以 $B_y=0$．
\begin{equation}
...
\begin{equation}\label{EMRef_eq8}
...
\begin{equation}\label{EMRef_eq7}
...
\end{equation}
这恰好与\autoref{EMRef_eq8} 和 \autoref{EMRef_eq7} 相符．
