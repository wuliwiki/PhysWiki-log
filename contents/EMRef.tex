...
到目前为止我们只在同一个参考系中分析电磁学问题， 我们下面以两个例题来分析在不同参考系之间电磁场该如何变换。 我们将会发现， 在讨论电磁场的参考系变换时必须考虑狭义相对论效应才能不发生矛盾， 即\enref{麦克斯韦方程组}{MWEq}天然与\enref{洛伦兹变换}{SRLrtz}而不是伽利略变换兼容。爱因斯坦创造狭义相对论时所发的论文 《论动体的电动力学》 讨论的就是这类问题。
...
\subsubsection{正确的分析}
上面对 $S$ 系的分析是正确的，空间中只有电场没有磁场。 在 $S'$ 系中的确会出现磁场， 但由于导线出现了相对论的 “尺缩短” 效应，%\addTODO{链接}
电荷密度变大， 电场也比原来要大。 另外由于粒子在两参考系中的速度不同， 所以受力也存在一定变换关系而不要求相等%\addTODO{链接}
...
B_{y} = 0~.
\end{equation}
在 $S'$ 中， 由尺缩效应，线电荷密度变为 $\lambda' = \gamma_u \lambda$， 电流为 $I' = \lambda' u = \gamma_u \lambda u$。根据安培环路定理（或斯托克斯定理），无限长直导线将产生切向方向的旋转对称的磁场，其大小与距直导线的距离 $r_0$ 成反比，即 $B'_y=\mu_0 I' /(2\pi r_0)$%\addTODO{引用具体例题}
。因此电磁场分别为
\begin{equation}
...
以上是直接从电荷计算出的结果。 一种更一般的角度是从 “电磁场在不同参考系中转换” 的角度来看待问题， 而不理会 $S$ 中的电磁场由什么样的电荷电流分布产生。 即 $S$ 系的电场经过某种线性变换后， 得到 $S'$ 系中的电场和磁场。 我们姑且假设这种变换必须是线性变换，%\addTODO{链接}
...
\end{equation}
其中 $\cross$ 表示\enref{矢量叉乘}{Cross}。 也就是说， 若参考系垂直电场方向移动， 则新参考系中电场会变强， 并且会出现一个磁场。
...
电磁场的变换公式可以通过\enref{电磁场张量}{EMFT}的变换公式得到。结果为
\begin{equation}
\begin{aligned}
