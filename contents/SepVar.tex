...
\pentry{一维波动方程\nref{nod_WEq1D}， 多元函数的傅里叶级数\nref{nod_NdFuri}}{nod_6145}

一维的波动方程（\autoref{eq_WEq1D_3}~\upref{WEq1D}）为
\begin{equation}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/be8db45f20c88e4f.pdf}
