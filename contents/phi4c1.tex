...
% license Xiao
% type Tutor
\pentry{LSZ约化公式（标量场）\upref{LSZ}，Wick 定理（标量场）\upref{wick}}{nod_16f1}
...
\begin{equation}\label{eq_phi4c1_2}
\begin{aligned}
...
\begin{equation}\label{eq_phi4c1_3}
\begin{aligned}
...
\begin{equation}\label{eq_phi4c1_1}
...
\end{aligned}
\end{equation}
将这个结果代入\autoref{eq_phi4c1_1} 可以得到
\begin{equation}
\begin{aligned}
...
除去上面讨论的 OS 方案，可以有许多不同的重整化方案来确定重整化常数。$\overline{MS}$ 方案被称为修正的最小减除方案，“最小减除”意味着重整化常数包含着恰好抵消紫外发散的项。根据\autoref{eq_phi4c1_2} 和\autoref{eq_phi4c1_3} 的计算结果，在 $\overline{MS}$ 方案中重整化常数取为
\begin{equation}
\begin{aligned}
