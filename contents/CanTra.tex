...
\end{equation}
显然也不含循环坐标 $q^s$。由哈密顿正则方程\autoref{eq_HamCan_2} 
...
\end{aligned}
\end{equation}
若将这一变换视作 $p_t,q_t$ 到 $p_{t+\tau},q_{t+\tau}$ 的坐标变换，则这即是正则变换，因为由\autoref{eq_EPAct_1} 
\begin{equation}
...
%首先， 根据勒让德变换\autoref{eq_HamCan_1}， 拉格朗日量可以表示为
%\begin{equation}
