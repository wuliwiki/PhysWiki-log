...
\item \href{http://www.feynmanlectures.caltech.edu}{费曼物理讲义}
\item \href{https://www.damtp.cam.ac.uk/user/tong/teaching.html}{David Tong Lecture}
\end{itemize}
...
\item \href{https://www.geogebra.org/}{Geogebra 教学互动插件框架}
...
\item \href{https://cortexjs.io/}{MathLive} 类似于 MathType 的网页公式输入（WYSIWYG），见 \href{https://github.com/arnog/mathlive}{GitHub}。
\item MathType （Wiris 公司）的\href{https://demo.wiris.com/mathtype/en/developers.php}{在线公式编辑器插件}。（另见\href{https://wuli.wiki/apps/mathtype/}{本站的部署}，js 源码被编译压缩）。Web 前端 WYSIWYG 公式编辑器的典范。甚至还支持手写识别， 格式化后大约 5 万行代码。
...
\subsubsection{知识树}
\begin{itemize}
\item \href{https://d3js.org/}{D3.js} 可视化（树状图等）
\item \href{https://jsmind.online/#sample}{jsmind} 脑图
\end{itemize}
