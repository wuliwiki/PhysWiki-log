...
\begin{figure}[ht]
\centering
\includegraphics[width=8.5cm]{./figures/Topo3_1.png}
...
由 “集合的内部、外部和边界\upref{Topo0}” 中\autoref{Topo0_cor1} 可知，\autoref{Topo3_the2} 中定义的 $B$ 就是 $A$ 添上若干边界点生成的；如果把边界点全都添上了，那就是 $\bar{A}$．