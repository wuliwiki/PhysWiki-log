...
\begin{exercise}{}
证明共轭子群\autoref{def_Group3_3}~\upref{Group3}的阶和原群相同。
\end{exercise}
\subsection{群的例子}
...
命名为 $C_n$ 是取“cyclic”的含义，而命名为 $\mathbb{Z}/n\mathbb{Z}$ 是为了说明循环群是整数加法群 $\mathbb{Z}$ 的商群（\autoref{ex_NormSG_4}~\upref{NormSG}），而商群是将来会提到的重要概念。
\end{example}
