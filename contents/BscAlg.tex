...
证明所需基础知识请参见\textbf{基本群}\upref{HomT3}．
...
在$\mathbb{C}$上选择任意一点$z_0$作为基点来构造基本群．设任意回路$r:S^1\rightarrow\mathbb{C}$，以及零回路$n:S^1\rightarrow\mathbb{C}$，其中$n(t)=z_0$对所有$t$成立．由于$\mathbb{C}$是可缩空间，因此必有$r\cong n$．由\autoref{HomT1_the2}~\upref{HomT1}，$f\circ r\cong f\circ n$，因此单位圆上的回路也彼此同伦．然而我们知道$S^1$的基本群是$\mathbb{Z}$，意味着并非所有回路都彼此同伦，因此出现了矛盾．
