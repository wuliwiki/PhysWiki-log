...
设刚体绕固定轴转动， 令轴的方向为 $\uvec z$。 假设轴光滑， 则轴对刚体可施加 $x, y$ 两个方向的力矩，却不能施加 $z$ 方向的力矩． 所以根据角动量定理， 角动量 $\vec L$ 的 $z$ 分量 $L_z$ 守恒． 我们下面来推导 $L_z$ 与角速度 $\omega$ 的关系． 矢量 $\vec L$ 与矢量 $\vec \omega$ 的关系见惯性张量\upref{ITensr}．
