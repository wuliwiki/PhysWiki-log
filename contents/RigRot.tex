...
我们可以把刚体的定轴转动类比\enref{质点的直线运动}{VnA1}， 把 $\theta$， $\omega$ 和 $\alpha$ 分别类比为直线运动中的位置 $x$， 速度 $v$ 和加速度 $a$， 因为后三个变量之间的数学关系是完全相同的： $v, \omega$ 分别是 $x, \theta$ 的一阶导数， 而 $a, \alpha$ 分别是 $x, \theta$ 的二阶导数。

于是我们可以立即类比\enref{匀加速直线运动}{CnstAL}得到\textbf{匀变速定轴转动}（即 $\alpha$ 为常数）的一些公式， 如
\begin{gather}
