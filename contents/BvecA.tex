...
\pentry{亥姆霍兹分解\upref{HelmTh}}{nod_b477}
...
若已知恒定电流分布如何求空间某点的磁矢势呢？ 当然我们可以先用比奥萨伐尔定律\upref{BioSav} 求出磁场分布再用\autoref{eq_BvecA_1} 求出磁矢势， 但也而已直接求出， 使用比奥萨法尔定律的旋度形式（\autoref{eq_BioSav_5}~\upref{BioSav}）
\begin{equation}
