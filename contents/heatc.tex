% 热传导定律、扩散方程与输运过程
% 热传导|输运过程|传递过程|粘滞定律|菲克定律

\pentry{热传导定律\upref{Heatco}}
%建议和上述条目合并
...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/heatc_2.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/heatc_1.pdf}
\caption{恒源扩散，\href{https://wuli.wiki/apps/diffus.html}{一个可视化的动图}} \label{heatc_fig1}
\end{figure}
\end{example}
...
其中牛顿粘滞方程的 $J_p$ 为动量流密度，一些参考文献上将粘滞定律写作 $\tau = -\mu \frac{\dd u}{\dd z}$，其中 $\tau$ 为剪应力，该方程则表达了剪应力与流体速度场的梯度成正比。这些方程从直观上是容易想象的，虽然宏观上代表不同的现象，但其方程形式却是相同的。在词条“气体输运过程”\upref{gasTra}中，我们将发现这三种输运过程在\textbf{微观上的机制}本质是相同的。
