...
\end{theorem}
\subsection{证明}
由\enref{张量的坐标变换}{TrTnsr}知道，若基底 $\{e_i\}$ 到基底 $\{e'_i\}$ 的转换矩阵为 $A^i_j$，逆矩阵为 $B^i_j$，那么任意张量 $T$ 在这两基底下的坐标变换规律（见\enref{张量的坐标变换}{TrTnsr}）为
\begin{equation}
