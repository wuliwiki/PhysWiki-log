...
\begin{definition}{柯西序列}\label{def_cauchy_3}
...
\begin{theorem}{}\label{the_cauchy_2}
...
% \addTODO{证明： 根据三角不等式（\autoref{def_Metric_2}）， 对任意 $n$ 都有 $\abs{d(x,y) - d(x_n, y)}\le d(x, x_n)$。 根据柯西序列定义}
