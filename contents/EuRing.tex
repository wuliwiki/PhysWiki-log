...
\pentry{主理想整环\upref{PID}}{nod_c8fc}
...
由于 $a, b\in I$ 且 $I$ 有吸收律\footnote{见\textbf{环的理想和商环}\upref{Ideal}，这意味着 $qb\in I$。}，故 $r\in I$。由于 $\delta(b)$ 是 $\delta(I)$ 中的最小非负值，因此必有 $\delta(r)=0$。由\autoref{the_EuRing_1} ，$r=0$。
