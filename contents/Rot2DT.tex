...
\begin{example}{旋转双曲线}
我们来证明函数 $y' = 1/x'$ 的曲线为双曲线\upref{Hypb3}． 由于双曲线标准方程表示的双曲线是关于 $x$ 轴对称的， 我们需要把 $(x', y')$ 顺时针旋转 $\pi/4$ 得到 $(x, y)$， 即上面的 $\alpha = \pi/4$． 把\autoref{Rot2DT_eq1} 和\autoref{Rot2DT_eq2} 代入 $y' = 1/x'$ 得
\begin{equation}
