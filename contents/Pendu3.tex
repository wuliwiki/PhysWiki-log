...
\pentry{拉格朗日方程\nref{nod_Lagrng}}{nod_ba7c}

\subsection{双摆}
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/41fc5e3b15f52b6a.pdf}
...
\caption{数值模拟结果， 动画见\href{https://wuli.wiki/apps/DbPend.html}{这里}， 代码见 “\enref{双摆的数值计算（Matlab）}{DbPend}”。} \label{fig_Pendu3_3}
\end{figure}
...
\caption{刚体双摆的模拟结果， 动画见\href{https://wuli.wiki/apps/RigDbPend.html}{这里}， 代码见 “\enref{双摆的数值计算（Matlab）}{DbPend}”。} \label{fig_Pendu3_4}
\end{figure}
...
\end{equation}
这里不具体写出 $\dot\omega_1, \dot\omega_2$ 的解， 可以直接使用\enref{克拉默法则}{kramer}。

\subsection{三摆}
\begin{figure}[ht]
\centering
\includegraphics[width=9cm]{./figures/42f1bfeb3c9da947.pdf}
