...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/faf3de0c3bdc0598.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/80c82acacfde3456.png}
\caption{数值模拟结果， 动画见\href{https://wuli.wiki/apps/DbPend.html}{这里}， 代码见 “双摆的数值计算（Matlab）\upref{DbPend}”。} \label{fig_Pendu3_3}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/abda44b0008f4e1d.png}
\caption{刚体双摆的模拟结果， 动画见\href{https://wuli.wiki/apps/RigDbPend.html}{这里}， 代码见 “双摆的数值计算（Matlab）\upref{DbPend}”。} \label{fig_Pendu3_4}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=9cm]{./figures/d14b3c499e693ce5.pdf}
