...
\pentry{电阻\upref{Resist}， 安培环路定理\upref{AmpLaw}， 法拉第电磁感应定律\upref{FaraEB}}
...
U = L\dv{I}{t}
\end{equation}
也就是说电势差与电流的时间导数成正比， 比例系数就是电感． 本书中电流和电压的方向可以按照被动符号规定（\autoref{Resist_sub1}~\upref{Resist}）， 即先规定一个正方向， 电流延该方向为正， 反之为负， 电势\upref{QEng}延该方向下降为正， 反之为负．
