...
基于函数图像，自然可以直观地读取某些特定角度的三角函数值。下面列出常用的三角函数值，其中包括的都是常见的解析值，也就是可以写成（解析的含义）。在高中阶段，通常只考察前四列的值，这些值可以通过三角函数的\enref{基本恒等式}{HsAnTf}推导得到。
...
$0$ & $0$ & $1$ & $0$ &- & $1$ &-\\
\hline
$\displaystyle\frac{\pi}{12}$ & $\displaystyle\frac{\sqrt{6} - \sqrt{2}}{4}$ & $\displaystyle\frac{\sqrt{6} + \sqrt{2}}{4}$ & $2 - \sqrt{3}$ & $2 + \sqrt{3}$ & $\displaystyle\frac{\sqrt{6} + \sqrt{2}}{2}$ & $\displaystyle\frac{\sqrt{6} - \sqrt{2}}{2}$ \\
\hline
...
\hline
$\displaystyle\frac{5\pi}{12}$ & $\displaystyle\frac{\sqrt{6} + \sqrt{2}}{4}$ & $\displaystyle\frac{\sqrt{6} - \sqrt{2}}{4}$ & $2 + \sqrt{3}$ & $2 - \sqrt{3}$ & $\displaystyle\frac{\sqrt{6} - \sqrt{2}}{2}$ & $\displaystyle\frac{\sqrt{6} + \sqrt{2}}{2}$ \\
\hline
