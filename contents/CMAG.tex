...
\begin{equation}
\left| {\Delta \vec v} \right| = \left| {\vec v} \right|\Delta \theta  = \left( {R\omega } \right)\omega \Delta t
\end{equation}
所以质点的加速度大小为
\begin{equation}
\left| {\vec a} \right| = \mathop {\lim }\limits_{\Delta t \to 0} \frac{{\left( {R\omega } \right)\omega \Delta t}}{{\Delta t}} = R{\omega ^2}\mathop {\lim }\limits_{\Delta t \to 0} \frac{{\Delta t}}{{\Delta t}} = R{\omega ^2}
\end{equation}
