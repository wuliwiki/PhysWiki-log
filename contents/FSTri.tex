...
\begin{equation}
f(x) = \leftgroup{
1& \quad && 2k\pi < x \leqslant (2k + 1)\pi \\
...
\begin{figure}[ht]
\centering
\includegraphics[width=4cm]{./figures/FSTri3.pdf}
...
\begin{equation}
f(x) = \leftgroup{
&\frac2a x &\quad (0 \leqslant x \leqslant \frac a2)\\
&2 -\frac2a x &\quad (\frac a2 < x \leqslant a)
}\end{equation}
