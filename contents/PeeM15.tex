...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/9ba6ed2aff1fa3db.png}
...
(C) 发散点，收敛点\\
(D) 发散点，发散点
\item  设 $D$ 是第一象限中的曲线 $2xy=1,4xy=1$   与直线 $y=x,y=\sqrt{3}x$  围成的平面区域，函数 $f(x,y)$   在 $D$ 上连续，则 $\displaystyle {\iint}_D f(x,y)\dd{x}\dd{y}$=($\quad$)\\
...
\item  设向量组 $\alpha_1,\alpha_2,\alpha_3$ 为 $R^3$ 的一个基,$\beta_1=2\alpha_1+2k\alpha_3,\beta_3=\alpha_1+(k+1)\alpha_3$.\\
...
\item 设矩阵 $\mat A=\pmat{0&2&-3\\-1&3&-3\\1&-1&a}$ 相似于矩阵 $\mat B=\pmat{1&-2&0\\0&b&0\\0&3&1}$ 。\\
(1)求 $a,b$ 的值；\\
