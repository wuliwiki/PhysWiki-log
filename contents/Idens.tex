...
上面我们从一个经典的宏观世界的角度考察了电流密度的定义。下面让我们回到\enref{电流的微观定义}{I}。假设介质中 $n$ 为载流子的数密度，$\bvec v$ 为介质中某一点载流子的平均运动速度。在垂直于 $\bvec v$ 方向画一个横截面 $\dd S$，容易写出电流 $I$ 的关系式：$I=ne\bvec v \cdot \dd{\bvec S}$。再根据电流密度的定义，我们有：
\begin{equation}
