...
。\autoref{eq_ODEa4_6} 被称为一个\textbf{奇解}，其图像也被称为\enref{包络线包络和奇解}{EnvSol}}。
...
按照在\enref{一阶常微分方程解法：恰当方程}{ODEa3}中讨论的方法，\autoref{eq_ODEa4_14} 有一个积分因子 $h(v)=v^{1/3}$，从而将\autoref{eq_ODEa4_14} 化为
\begin{equation}
