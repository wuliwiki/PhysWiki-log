...
\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Brachistochrone_curve}{相关页面}．}在一个竖直平面上任意取两个不同的点 $P_1, P_2$， $P_1$ 的高度大于等于 $P_2$． 一个静止的质点在 $P_1$ 处释放， 在恒定的重力的作用下沿某曲线 $\mathcal L$ 无摩擦地运动到 $P_2$， 耗时为 $t$． 若一条曲线 $\mathcal L$ 使得 $t$ 最短， 那么这个曲线就是 $P_1, P_2$ 两点间的\textbf{最速降线（brachistochrone）}．

通过下文的推导可以发现， 最速降线必定是摆线． 然而连接两点的摆线有无穷多条， 其中只有一条是最速降线． 最速降线对应的摆线是起点参数为 $\theta = 0$ 的那条， 即初始斜率为无穷大．

\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/Brachi_1.png}
...
\end{equation}
这相当于摆长为 $2a$ 的单摆\upref{Pend}的小幅摆动周期． 这是因为摆线底部的曲率半径\upref{curvat}是 $2a$．
