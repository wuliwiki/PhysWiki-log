...
\footnote{参考 Wolfram MathWorld \href{https://mathworld.wolfram.com/BrachistochroneProblem.html}{相关页面}．}令 $x$ 轴向右， $y$ 轴向下． 质点由原点出发， 在重力加速度 $g$ 的作用下沿曲线 $y(x)$ 运动． 由动能定理得
\begin{equation}
v = \sqrt{2gy}
\end{equation}
...
代入\autoref{Brachi_eq3} 得最短的时间为
\begin{equation}
t_{12} = \sqrt{\frac{a}{g}}(\theta_2 - \theta_1)
\end{equation}
其中 $\theta_1, \theta_2$ 分别对应 $x_1, x_2$．
