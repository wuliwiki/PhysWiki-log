...
\pentry{流形\upref{Manif}，光滑映射（流形）\upref{DiffTg}，切向量场\upref{Vec}}{nod_54fd}
\begin{issues}
\issueTODO缺图
\end{issues}
...
对于右侧，由乘积映射的\autoref{def_map_2}~\upref{map}，我们有：
\begin{equation}
...
\pentry{仿射联络\upref{affcon}，协变导数\upref{CoDer}}{nod_996a}
