...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/DipRad_4.png}
...
\caption{$X$轴上的电场矢量场．在远处辐射场行为类似平面电磁波\upref{VcPlWv} } \label{DipRad_fig1}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/DipRad_3.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/DipRad_2.pdf}
