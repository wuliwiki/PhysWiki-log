...
\pentry{量子散射的延迟\upref{tDelay}， 含时微扰理论\upref{TDPT}， 库仑函数\upref{CulmF}}
...
\end{equation}
相位不随 $k$ 或 $E$ 变化。 注意对于氢原子束缚态作为初始态， 由于选择定则\upref{SelRul} $\Delta m = 0$， $\Delta l = \pm 1$， 只有最多两个 $c_{l,m}$ 不为零。
