...
\pentry{端点可变问题\upref{EPQue}}{nod_1a20}
所谓的\textbf{斜截条件}是变端问题中\upref{EPQue}使得泛函 $J$ （\autoref{eq_EPQue_1}~\upref{EPQue}）取极值的曲线的端点所满足的条件。它是指下面两个方程
...
\end{theorem}
\subsection{证明}
由\autoref{sub_EPQue_1}~\upref{EPQue}中的注意及\autoref{the_EPQue_1}~\upref{EPQue}。给出积分\autoref{eq_OCCond_2} 的曲线必定是极端曲线，且要在诸极端曲线中找到使 $J$ 达到极值的弧，对于任意的 $\delta x_0,\delta x_1$ ，有
\begin{equation}
