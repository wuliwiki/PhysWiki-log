...
&\qquad  \iint Y_{l_1m_1}^*(\uvec r_1)Y_{l_2m_2}^*(\uvec r_2)Y_{10}(\uvec r_1)Y_{l_1' m_1'}(\uvec r_1)Y_{l_2 m_2}(\uvec r_2) \dd{\Omega_1}\dd{\Omega_2}\\
&= \delta_{l_2, l_2'} \sqrt{(2l_1 + 1)(2l_1'+1)} r \sum_{m_1,m_2, m_1'} \bmat{l_1 & l_2 & L\\ m_1 & m_2 & M} \bmat{l_1' & l_2 & L'\\ m_1' & m_2 & M'} \times\\
...
&= \delta_{l_1, l_1'} \sqrt{(2l_2 + 1)(2l_2'+1)} r \sum_{m_1,m_2, m_2'} \bmat{l_1 & l_2 & L\\ m_1 & m_2 & M} \bmat{l_1 & l_2' & L'\\ m_1 & m_2' & M'} \times\\
...
&= \frac{\delta_{l_2, l_2'}}{\sqrt2} \sqrt{(2l_1 + 1)(2l_1'+1)} r \sum_{m_1,m_2, m_1'} \bmat{l_1 & l_2 & L\\ m_1 & m_2 & M} \bmat{l_1' & l_2 & L'\\ m_1' & m_2 & M'} \times\\
...
&= \frac{\I\delta_{l_2, l_2'}}{\sqrt2} \sqrt{(2l_1 + 1)(2l_1'+1)} r \sum_{m_1,m_2, m_1'} \bmat{l_1 & l_2 & L\\ m_1 & m_2 & M} \bmat{l_1' & l_2 & L'\\ m_1' & m_2 & M'} \times\\
&\qquad  \pmat{l_1 & 1 & l_1'\\ 0 & 0 & 0} \qty[\pmat{l_1 & 1 & l_1'\\ m_1 & -1 & m_1'} + \pmat{l_1 & 1 & l_1'\\ m_1 & 1 & m_1'}]
}\end{equation}

\begin{equation}\ali{
&\mel{\mathcal{Y}_{l_1 l_2}^{LM}}{x_2}{\mathcal{Y}_{l_1' l_2'}^{L'M'}}\\
&= \frac{\delta_{l_1, l_1'}}{\sqrt2} \sqrt{(2l_2 + 1)(2l_2'+1)} r \sum_{m_1,m_2, m_2'} \bmat{l_1 & l_2 & L\\ m_1 & m_2 & M} \bmat{l_1 & l_2' & L'\\ m_1 & m_2' & M'} \times\\
&\qquad  \pmat{l_2 & 1 & l_2'\\ 0 & 0 & 0} \qty[\pmat{l_2 & 1 & l_2'\\ m_2 & -1 & m_2'} - \pmat{l_2 & 1 & l_2'\\ m_2 & 1 & m_2'}]
}\end{equation}

\begin{equation}\ali{
&\mel{\mathcal{Y}_{l_1 l_2}^{LM}}{y_2}{\mathcal{Y}_{l_1' l_2'}^{L'M'}}\\
&= \frac{\I\delta_{l_1, l_1'}}{\sqrt2} \sqrt{(2l_2 + 1)(2l_2'+1)} r \sum_{m_1,m_2, m_2'} \bmat{l_1 & l_2 & L\\ m_1 & m_2 & M} \bmat{l_1 & l_2' & L'\\ m_1 & m_2' & M'} \times\\
&\qquad  \pmat{l_2 & 1 & l_2'\\ 0 & 0 & 0} \qty[\pmat{l_2 & 1 & l_2'\\ m_2 & -1 & m_2'} + \pmat{l_2 & 1 & l_2'\\ m_2 & 1 & m_2'}]
}\end{equation}
