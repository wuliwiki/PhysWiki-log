...
V_F = \bvec{\mathcal E} \vdot \bvec r = {\mathcal E}_x x + {\mathcal E}_y y + {\mathcal E}_z z~
\end{equation}
与氢原子的情况相同， 有
\begin{equation}
...
\begin{equation}
\begin{aligned} % 数值验证相同
&\mel{\mathcal{Y}_{l_1 l_2}^{LM}}{z_i}{\mathcal{Y}_{l_1' l_2'}^{L'M'}}=
r\sqrt{9(2l'_1+1)(2l'_2+1)(2L'+1)/(4\pi)^2}\\
& \quad\times \begin{bmatrix}\delta_{i,1} & l'_1 & l_1\\ 0 & 0 & 0\end{bmatrix}
  \begin{bmatrix}\delta_{i,2} & l'_2 & l_2\\ 0 & 0 & 0\end{bmatrix}
  \begin{bmatrix}1 & L' & L\\ 0 & 0 & 0\end{bmatrix}
   \qty{\begin{matrix} \delta_{i,1} & l'_1 & l_1\\ \delta_{i,2} & l'_2 & l_2\\ 1 & L' & L\end{matrix}} \quad (i=1,2)~,
\end{aligned}
\end{equation}
...
积分 $\mathcal C_{l,m}$ 可以参考\autoref{eq_HyTDSE_11}。 同理，
