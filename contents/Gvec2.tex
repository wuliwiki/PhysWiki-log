...
在 “几何矢量\upref{GVec}”中， 我们对坐标有了一个简单的认识． 本文中， 我们将从基底的角度进一步讨论坐标的定义． 
...
\end{equation}
这里的 $N$ 个有序实数 $(x1, x2, \cdots, x_N)$ 就是 $\bvec v$ 关于基底 $\qty{\bvec \beta_i}$ 的\textbf{坐标（coordinates）}． 我们说该坐标属于集合 $\mathbb R^N$， 即实数集 $\mathbb R$ 自身的 $N$ 次笛卡尔积（\autoref{Set_eq1}~\upref{Set}）． 主要不要把这种表示和行矢量（$1\times N$ 的矩阵）混淆．
