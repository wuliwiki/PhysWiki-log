...
先来看一幅等高线图（\autoref{DerDir_fig1}）． 令高度 $z$ 为位置的函数$z = f(\bvec r)$． 这里 $\bvec r$ 是二维平面上的位矢\upref{Disp}， 即 $f(\bvec r) = f(x,y)$． 当位矢沿着等高线移动时， $z$ 不变，而当位矢沿垂直于等高线的方向移动时， $z$ 变化得最快．位置沿其他方向运动， $z$ 的变化速度介于两者之间．
