...
\bb{位置矢量（位矢）}就是从坐标原点指向某一点的矢量，通常记为 $\bvec r$． 当定义了一个坐标系，那么坐标系中一点的位置就可以用位矢表示．
...
在物体运动过程中，可以把物体的位矢看做时间的矢量函数 $\bvec r(t)$，则\bb{位移} $\Delta \bvec r$ 是一段时间 $[t_1,t_2]$ 内物体初末位矢的矢量差
\begin{equation}
...
， 矢量内积\upref{Dot}}
\begin{exam}{证明 $\dd{r} = \uvec r \vdot \dd{\bvec r}$}\label{Disp_ex1}
