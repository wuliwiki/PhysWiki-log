...
按优先级排序
\begin{itemize}
\item 编辑器预览中， 凡是其他页面的连接点击以后都在浏览器上新开一页， 直接在预览窗口里面跳到其他页面就会出问题
...
\item 百科编辑器要求只有管理员可以导出 md， 用户笔记人人都可以导出

\item 有时候笔记页面登录后编辑器窗口不显示任何内容

\item 引用其他词条内容后， 点击预览中的链接有误． 应该使用 scan 输出的链接． 例如 \verb|https://wuli.wiki/editor/Resist.html#sub1| 中 \verb|editor| 应该是 \verb|online|．
...
\item \verb|MWRel.tex| 中没有显示用户 \verb|_Eden_| 的编辑历史． 在 \verb|PhysWiki-backup| 中却有．
