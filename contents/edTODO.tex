...
\begin{itemize}
\item 增加一个脚注按钮， 插入 \verb|\footnote{脚注}|， 并自动选中 “脚注”

\item 增加一个代码按钮， 图标为 \verb|</>|， 按下以后弹出输入框 “请指定语言（不指定则没有高亮）” \verb|"\\begin{lstlisting}[language=输入的语言]\n${1}\n\\end{lstlisting}"|
...
\item 【完成】选中一段文字后点击链接按钮， 插入 \verb|\href{http://www.example.com}{被选中的文字}|， 自动选中网址
