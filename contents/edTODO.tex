...
按重要性排序
\begin{itemize}
\item 有时候网速慢时保存以后代码中的光标会卡住， 直到预览刷新了以后还要过几秒种才能恢复
...
\item 【完成】如果 main.tex 中词条标题含有反斜杠， 则高亮不正常
...
\item 在粗体按钮右边增加一个斜体按钮， 图标是斜体的 \verb|I|， 插入命令 \verb|\textsl{}|， 功能和粗体按钮一模一样（包括选中文字以后再按下的效果）
