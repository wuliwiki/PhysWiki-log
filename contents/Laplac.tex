...
\pentry{梯度、梯度定理\nref{nod_Grad}， 散度、散度定理\nref{nod_Divgnc}}{nod_1b6c}
...
\subsection{在物理中的应用}
在\enref{二维波动方程}{Wv2D}中， 薄膜上一个小面源的受力正比于薄膜形状 $u(x, y)$ 在该处的拉普拉斯。 结合牛顿第二定律， 就得到了二维波动方程
\begin{equation}
\laplacian u - \frac{\sigma}{\lambda}\pdv[2]{u}{t} = 0~.
\end{equation}

在静电学中， 电势 $V$ 的梯度是电场的负， 而电场的散度是电荷密度 $\rho$ 除以电介质常数 $\epsilon_0$， 这样就得到了\enref{静电场的泊松方程}{EPoiEQ}
\begin{equation}
...
在热力学中， 对一块均匀的各向同性的介质， 温度和能量密度 $u$ 成正比， 温度的梯度和能流密度成正比， 而能流密度的散度和能量密度的变化率成正比， 于是有\enref{热传导方程}{heatc}
\begin{equation}
