...
\subsubsection{Magic Trackpad}
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/19430ed515d7d646.png}
...
\item Apple Silicon 中就算用虚拟机（如 Parallel Desktop）也几乎只能跑其他系统的 arm 版本。 Parallel Desktop 开始实验性支持 x86 的 emulation， 但是非常非常慢。
