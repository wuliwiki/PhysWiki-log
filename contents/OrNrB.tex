% 正交归一基底
% 线性代数|矢量|正交归一基|单位正交基|克罗内克 δ 函数|克罗内克 delta 函数

\pentry{矢量内积\upref{Dot}}

我们已经知道了矢量基底的概念， 如果一组矢量基底中的每个矢量模长都为 $1$ 且每两个矢量都正交， 则我们把这组基底称为\bb{正交归一基} 或\bb{单位正交基}． 若把这组正交归一基记为 $\uvec x_1,\uvec x_2\dots\uvec x_n$， 则正交归一可以用内积表示为
\begin{equation}
