% 高斯恒等式（黎曼几何）
% keys Theorema Egregium|高斯绝妙定理|微分几何|黎曼几何|相对黎曼几何
% license Xiao
% type Tutor

\begin{issues}
\issueDraft
\issueOther{待添加词条《截面曲率》}
\end{issues}

\pentry{曲率张量场\upref{RicciC}}{nod_15cd}

\addTODO{\href{https://en.m.wikipedia.org/wiki/Second_fundamental_form\#Hypersurface_in_a_Riemannian_manifold}{参考1}，\href{https://en.m.wikipedia.org/wiki/Gauss\%E2\%80\%93Codazzi_equations}{参考2}}
