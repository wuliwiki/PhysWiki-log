...
g = \leftgroup{&GM_0(r)/r^2 &\quad &(r < R)\\ &GM/r^2 && (r > R)}
\end{equation}
其中
\begin{equation}
...
g = \leftgroup{&\frac{4}{3}G\pi \rho r &\quad &(r < R)\\ &GM/r^2 && (r > R)}
\end{equation}

记在距离球心距离为 $r$ 的场点处，单位质量所具有的引力势能为 $\nu(r)$,称之为势函数．规定距离球心无穷远处的势能为零，则势函数的定义式为：
\begin{equation}
\nu(r) = \int_\infty^r g(r) \dd{r}
\end{equation}
将\autoref{SphF_eq13} 代入，得均匀球体的势函数分布
\begin{equation}
\nu(r) = \leftgroup{&\frac{2}{3}G\pi \rho \qty(r^2-R^2)-GM/r &\quad &(r < R)\\ &-GM/r && (r > R)}
\end{equation}
