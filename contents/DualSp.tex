...
\end{equation}
就是把$\bvec{f}\bvec{v}$记为$\langle \bvec{f}, \bvec{v} \rangle$\footnote{注意，对偶向量的相互作用和两个向量的内积在概念上有所不同。作内积需要额外定义“内积”这一双线性函数多线性映射\upref{MulMap}。}。
