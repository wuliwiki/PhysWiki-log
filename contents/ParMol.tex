...
\pentry{热力学关系式\upref{MWRel}}{nod_3d39}
...
\pentry{盖斯定律与设计路径\upref{Hess}}{nod_83b8}
...
\end{equation}
如果我们将上式两边对 $t$ 求偏导，那么由复合函数的偏导、链式法则（多元微积分）\upref{PChain}，可以得到
...
同理，我们可以定义其他\textbf{广延量}对应的偏摩尔量，常见的广延量有吉布斯自由能\upref{GibbsG}，熵\upref{Entrop}，体积等，在热力学中它们满足以下基本关系式（不管是在单元体系中还是在多元体系中）
