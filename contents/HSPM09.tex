...
\pentry{圆周运动\nref{nod_HSPM05}， 功和机械能\nref{nod_HSPM07}}{nod_b912}
...
当摆角 $\theta$ 很小时，有 $\sin\theta \approx \theta$\footnote{参考：\enref{小角极限（简明微积分）}{LimArc}}，摆球的位移大小 $x$ 近似于 $L\theta$，可得回复力 $F \approx -mgx/L$，符合\autoref{eq_HSPM09_1} 的形式，此时可把单摆的摆动近似看成简谐运动，将 $k=mg/L$ 代入\autoref{eq_HSPM09_4} 可得单摆做简谐运动的周期为
\begin{equation}
T=2\pi\sqrt{\frac Lg}~.
\end{equation}
