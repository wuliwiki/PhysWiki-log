...
\pentry{圆周运动\upref{HSPM05}， 功和机械能\upref{HSPM07}}{nod_b912}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/27dd09439f5fc0ce.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7.2cm]{./figures/d117a67257223a12.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7cm]{./figures/b77632b218e86b8f.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7cm]{./figures/cfb61e9cc47d7873.png}
\caption{单摆受力分析} \label{fig_HSPM09_3}
\end{figure}

当摆角 $\theta$ 很小时，有 $\sin\theta \approx \theta$\footnote{参考：小角极限（简明微积分）\upref{LimArc}}，摆球的位移大小 $x$ 近似于 $L\theta$，可得回复力 $F \approx -mgx/L$，符合\autoref{eq_HSPM09_1} 的形式，此时可把单摆的摆动近似看成简谐运动，将 $k=mg/L$ 代入\autoref{eq_HSPM09_4} 可得单摆做简谐运动的周期为
\begin{equation}
T=2\pi\sqrt{\frac Lg}~.
\end{equation}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8.5cm]{./figures/173e812dd378323e.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8.5cm]{./figures/ceeacc9d5e97ee93.png}
