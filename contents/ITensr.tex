...
\subsubsection{推导}
我们把刚体看作\enref{质点系刚体}{RigBd}，刚体绕固定点转动时， 刚体上的每个点都在做瞬时圆周运动。 根据角动量的定义\autoref{eq_AngMom_1}  以及圆周运动的速度\autoref{eq_CMVD_5} 
\begin{equation}
...
\end{equation}
其中使用了酉矩阵的性质 $\mat R^{-1} = \mat R\Tr$ （\autoref{eq_UniMat_2}）。 注意该式是一个\enref{相似变换}{MatSim}， 所以 $\mat I$ 和 $\mat I_0$ 互为相似矩阵。
