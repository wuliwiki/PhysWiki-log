...
又称\textbf{基本电荷}，是一个电子或一个质子所带电荷量的绝对值，用字母$e$表示，$e = 1.602176634 \times 10^{-19} \mathrm{C}$\footnote{详见“\enref{物理学常数}{Consts}”}，近似计算时取$e = 1.60 \times 10^{-19} \mathrm{C}$。任何带电体所带的电荷量都是元电荷的整数倍。
