...
% license Xiao
% type Tutor
\pentry{近独立子系\upref{depsys}，盒中的电磁波\upref{EBBox}}{nod_e209}
...
\subsection{巨正则系综方法}
\pentry{等间隔能级系统（正则系宗）\upref{EqCE}}{nod_a4d9}
\addTODO{这个方法实际上是巨正则系综，光子数不确定，需要用巨配分函数。需要改一下描述，计算过程是不变的。需要引用巨正则系综的词条}
