...
\item 在$C$点处（固相线），系统中开始析出$\beta$相。注意\enref{{不同于}共晶转变}{EUTECT}中“一个液相生成两个固相$L\to\alpha+\beta$”，此处的转变是原有的固相$\alpha$与液相$L$转变为另一种新的一种固相$\beta$: $\alpha+L\to\beta$，被称为包晶转变。
