...
\begin{example}{一维自由粒子}\label{PpgtQM_ex1}
...
\end{equation}
根据\textbf{高斯积分}\upref{GsInt}\autoref{GsInt_eq5}~\upref{GsInt} ，或者如果你对高斯积分向复数的拓展有疑虑的话，根据\textbf{留数定理}\upref{ResThe}\autoref{ResThe_ex3}~\upref{ResThe}，知$\int \E^{-\I b^2}\dd b = \sqrt{\frac{\pi}{\I}} = \sqrt{\frac{\pi}{2}}(1-\I)$．代入\autoref{PpgtQM_eq6} 得
