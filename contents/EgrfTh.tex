...
\pentry{可测函数\upref{MsbFun}}{nod_e904}
...
如果 $\{E_k\}$ 的上极限（\autoref{def_SetLim_1}~\upref{SetLim}）为 $\varnothing$\footnote{注意下极限必是上极限的子集，因此这意味着 $\{E_k\}$ 的上极限等于其下极限，也就是其极限。}，那么 $\lim\limits_{k\to\infty}\opn{m}E_k=0$。
\end{lemma}
