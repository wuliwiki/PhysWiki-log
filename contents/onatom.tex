...
\pentry{小振动\upref{Oscil}}{nod_3dc0}
...
\subsection{声子与元激发}
\pentry{量子简谐振子（升降算符法）\upref{QSHOop}}{nod_6fd3}
...
我们可以对“\textbf{声子气体}”作研究来探索晶格的热力学性质。由统计力学的玻色爱因斯坦分布\upref{MBsta}可以知道声子的频率分布函数，进而求得晶格振动所导致的内能与热容。晶格热容的爱因斯坦理论\upref{EScap} 与 晶格热容的德拜理论\upref{Debye} 正是运用了这一思想。
