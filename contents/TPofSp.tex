...
在\enref{张量的张量积}{TsrPrd}中我们已经定义过线性映射（对偶向量）的张量积了：考虑 $f \in V^*_1,g \in V^*_2$，我们有 $(f \otimes g)(v_1, v_2) = f(v_1) f(v_2)$，其中 $f \otimes g \in \mathcal L(V_1,V_2;\mathbb F)$ 是双线性映射。
...
注意：上述的引理和推论，将向量空间和其对偶空间互调仍然成立，因为彼此是对方的对偶空间（参考\enref{对偶空间}{DualSp}），因此我们可以定义
\begin{equation}
