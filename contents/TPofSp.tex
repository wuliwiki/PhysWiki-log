...
对于有限维度矢量空间来说，我们可以用对偶空间 $V^*$ \upref{DualSp}和多线性映射空间 $\mathcal L(V_1,V_2;\mathbb F)$ \upref{MulMap}来定义来定义它们之间的张量积。
...
注意：上述的引理和推论，将矢量空间和其对偶空间互调仍然成立，因为彼此是对方的对偶空间（参考对偶空间\upref{DualSp}），因此我们可以定义
\begin{equation}
