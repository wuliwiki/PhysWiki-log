...
对于有限维度向量空间来说，对偶对偶空间同构于原空间（\autoref{the_DualSp_4}），因此我们可以用对偶空间 $V^*$ \upref{DualSp}和多线性映射空间 $\mathcal L(V_1,V_2;\mathbb F)$ \upref{MulMap}来定义来定义它们之间的张量积。
...
由向量空间张量积的定义（\autoref{def_vecTsr_1}），\textbf{证得}对 $(\sigma,\mathcal L(V^*_1,V^*_2,\mathbb F))$ 就是 $V_1,V_2$ 的张量积。
