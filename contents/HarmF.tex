...
\end{corollary}
证明： 有界调和场对调和场的各个分量也是有界的， 根据\autoref{HarmF_the2} 它们都是调和函数， 分别使用刘维尔定理（\autoref{LapEq_the1}~\upref{LapEq}）得每个分量都是常数， 所以矢量场也是常矢量场． 证毕．
...
\end{theorem}
证明： 令调和场为 $\bvec f = \div u$， $u$ 是一个调和函数． 易证 $\abs{\bvec f}^2$ 也是一个调和函数． 对其使用刘维尔定理（\autoref{LapEq_the1}~\upref{LapEq}）即可， 证毕．
