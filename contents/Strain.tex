...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/8719ca6a65ed77f4.pdf}
\caption{材料变形后，材料中的每一点的位置发生改变} \label{fig_Strain_1}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/d18a83d1bf06ce02.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/879d4e0af6d8a565.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/ab58128470021281.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/04d56fc7696dd959.pdf}
\caption{$u_1=1.5$。各应变均为$0$，微元形状不变、只发生平移。} \label{fig_Strain_9}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/677f1239ef06da3a.pdf}
\caption{$u_1=0.2x_1$。$\varepsilon_{11}=0.2$（其余项为$0$），微元发生拉伸变形} \label{fig_Strain_5}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/efbfde80acec4c54.pdf}
\caption{$u_1=0.2x_2$. $\varepsilon_{12}=0.1$,微元发生简单的剪切变形} \label{fig_Strain_6}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/74603956ec26f105.pdf}
\caption{$u_1=0.2x_2, u_2=0.2x_1$.$\varepsilon_{12}=0.2$，微元发生剪切变形} \label{fig_Strain_8}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/908be476f7cb3064.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8 cm]{./figures/27a61c9e2617ed79.png}
