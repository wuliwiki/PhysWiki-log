...
\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Resonance}{相关页面}。}如同讨论\enref{类氢原子}{HWF}中的那样，原子系统是存在能级的，从而可以用特定频率的光去激发，而这种行为也可以一般的描述为共振。Wikipedia说
...
共振有不同的线型。刚才说的热展宽，由于原子速度是玻尔兹曼分布，所以是Gaussian线型；而原子自己的能级则是Lorentzian线型，它对应于谐振子的阻尼振荡\upref{SHOfF}，其中幅频关系\autoref{eq_SHOfF_5} 为
\begin{equation}
