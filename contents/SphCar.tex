...
其中 $\Arctan$ 函数（也记为 $\opn{atan2}$）的定义见\autoref{Arctan_eq1}~\upref{Arctan}． 注意根据\autoref{SphCar_eq1}， 同一个直角坐标可以对应不同的极坐标， 例如将 $\phi$ 增加 $2\pi$ 的整数倍， 由例如对 $z$ 轴上的点 $\phi$ 可以取任意值． 但根据\autoref{SphCar_eq2}， 我们可以找到两种坐标间的一一对应\upref{Set}关系．
