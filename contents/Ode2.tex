...
\pentry{常微分方程\nref{nod_ODE}， 指数函数（复数）\nref{nod_CExp}}{nod_d889}

\begin{issues}
\issueOther{需要补充例题。}
\end{issues}

更深入的讨论，可参见\textbf{常系数线性齐次微分方程}\upref{ODEb2}。
...
应用常微分方程解的存在唯一性定理， 即\enref{皮卡-林德勒夫定理}{PiLin}, 我们可以确认： \textbf{方程 (1) 的通解一定是上面四种情况之一。}
