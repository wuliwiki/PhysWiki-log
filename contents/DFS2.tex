...
\pentry{深度优先搜索（DFS）\upref{DFS} 单链表\upref{List}}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/b5c8a419f14e2152.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/875faa0f44c1da2b.png}
