...
\end{equation}
一般用分离变量法解该方程， 通解为\autoref{TDSE11_eq4}~\upref{TDSE11}． 但首先要解出对应的定态薛定谔方程
\begin{equation}
...
\autoref{FreeP1_eq3} 相当于把波函数在正交归一的基底 $\psi_k(x) = \E^{\I kx}/\sqrt{2\pi}$ 展开， 满足正交归一条件（\autoref{COrNoB_eq8}~\upref{COrNoB}）
\begin{equation}
