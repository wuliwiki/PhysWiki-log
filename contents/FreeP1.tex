...
\end{equation}
直观上来理解， \autoref{eq_FreeP1_2} 和\autoref{eq_FreeP1_3} 都表示许多不同频率的平面波的叠加，所以是等效的， 系数 $A_\pm(\omega)$ 和 $C(k)$ 具有对应关系， 以后我们会看到他们之间如何\enref{转换}{EngNor}。 注意\autoref{eq_FreeP1_3} 恰好是 $C(k)$ 的反傅里叶变换（\autoref{eq_FTExp_1}）。 当 $t = 0$ 时有
\begin{equation}
