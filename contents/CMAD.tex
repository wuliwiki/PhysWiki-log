...
在圆周运动中，位矢 $\bvec r$ 是时间的函数。对时间求导后，我们得到速度矢量关于时间的函数。对速度也进行同样的操作，就不难得到圆周运动的\enref{加速度}{VnA}。
\begin{equation}
...
我们已知匀速圆周运动的速度大小为 $\abs{\bvec v} = R\omega$， 根据“\enref{小角极限}{LimArc}”中的结论，把 $\Delta\bvec v$ 的长度用弧长近似，得
\begin{equation}
...
\end{equation}
要验证该式与\autoref{eq_CMAD_4} 吻合， 把\enref{连续叉乘化为内积}{TriCro}得
\begin{equation}
