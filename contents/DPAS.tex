...
\pentry{曲线的长度\nref{nod_CurLen}， 速度、加速度\nref{nod_VnA}}{nod_418d}

我们已经处理了质点\enref{位矢与位移}{Disp} , 的问题。接下来我们要问的是，质点从$t_0$至$t_1$这段时间之内运动的距离（或者说，路程）是多少？
...
这就需要我们复习一下我们计算曲线长度时所用的套路“\enref{化曲为直}{CurLen}”。将这段时间分成一段段很小的时间间隔，在每一段小时间内，位移的模长$\abs{\Delta \bvec r}$就近似等于路程$\Delta s$。
