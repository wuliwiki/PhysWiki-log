...
\pentry{薛定谔方程\upref{TDSE}， 隧道效应}

\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Tunnel_ionization}{相关页面}。}本文使用原子单位制\upref{AU}。 在 $E \ll 1$ 的恒定电场下， 氢原子的电离率（单位时间的概率）为
\begin{equation}
...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/ee91a1e98c7fa146.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/03b83b353b68901a.png}
\caption{氢原子隧道电离的数值模拟（见“球坐标系中的定态薛定谔方程\upref{RadSE}”）} \label{fig_Htunnl_2}
\end{figure}
...
另见ADK 电离率\upref{ADKrat}， Keldish 模型（未完成）。
