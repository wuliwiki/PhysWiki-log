...
\end{definition}
由于实二次型均可化为标准型\autoref{the_RQuaF_1}~\upref{RQuaF}，故实二次型的各种类型对应的标准型如下（$n=\mathrm{dim}_\mathbb R \,V$）：
\begin{enumerate}
...
与正定二次型相配极的\enref{双线性型}{QuaFor}称为\textbf{正定的}。
\end{definition}
