...
\pentry{位移\upref{Disp}， 复合函数求导\upref{ChainR}}{nod_33d2}
...
\end{example}
事实上， 任何匀加速直线运动都可以表示为\autoref{eq_VnA1_1} 的形式， 详见 “匀加速直线运动\upref{CnstAL}”。
...
\pentry{牛顿—莱布尼兹公式\upref{NLeib}}{nod_d3d6}
