...
x(t_2) - x(t_1) = \int_{t_1}^{t_2} v(t) \D t
\end{equation}
...
\begin{equation}
x(t) = x_0 + \int_{t_0}^t v_0 \D t = x_0 + v_0 t
\end{equation}
\end{exam}

与\autoref{VnA1_eq4} 和\autoref{VnA1_eq5} 同理，一维速度和加速度之间也有类似关系
\begin{equation}
v(t_2) - v(t_1) = \int_{t_1}^{t_2} a(t) \D t
\end{equation}
\begin{equation}\label{VnA1_eq8}
v(t) = v_0 + \int_{t_0}^t a(t') \D t'
\end{equation}
...
\begin{equation}
v(t) = v_0 + \int_{t_0}^t a_0 \D t' = v_0 + a_0 t
\end{equation}
然后再次积分得到位置函数
\begin{equation}
x(t) = x_0 + \int_{t_0}^t (v_0 + a_0 t) \D t' = x_0 + v_0 t + a_0 t^2/2
\end{equation}
\end{exam}