...
\pentry{复数（Complex Numbers）\nref{nod_CplxNo}， 矢量叉乘（Cross Product）\nref{nod_Cross}}{nod_6507}
...
For a similar topic, please refer to \enref{矩阵指数（matrix exponential）}{MatExp}. The property of the matrix exponential correspond to that of the quaternions, related by the matrix representation of quaternions. 
