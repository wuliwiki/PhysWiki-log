...
\pentry{复数（Complex Numbers）\upref{CplxNo}， 矢量叉乘（Cross Product）\upref{Cross}， 几何矢量的内积（Inner Product of Geometric Vectors）\upref{Dot}}
...
\begin{equation}\label{QuaRot_eq2}
\begin{aligned}
