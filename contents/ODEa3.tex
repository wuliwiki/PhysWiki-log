% 一阶常微分方程解法：恰当方程
% 恰当方程|微分方程|ODE|ordinary differential equation|exact equation|积分因子|integration factor
...
这和\textbf{一阶常微分方程解法：常数变易法}词条中\autoref{eq_ODEa2_2}~\upref{ODEa2}的结论是一样的。
