...
\pentry{运动积分\upref{motint}，中心力场问题\upref{CenFrc}}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7cm]{./figures/twoobj_1.png}
...
\end{aligned}
\end{equation}
其中 $k=-k_eq_1q_2=-q_1q_2/(4\pi\epsilon_0)$（这里 $k_e$ 是静电常数）．该公式与\autoref{RuthSc_eq1}~\upref{RuthSc}是一致的．