...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/5b2d35931a67da80.pdf}
...
\end{equation}
\begin{example}{}
Euler-Mascheroni常数\upref{Masche}由调和级数与自然对数的差值的极限所给出，利用\autoref{eq_EMSum_3} 和该常数可以给出类调和级数前 $n$ 项和较好的计算公式，即
\begin{equation}
