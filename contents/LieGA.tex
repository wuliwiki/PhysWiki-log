...
\addTODO{需要证明$\mathfrak{gl}(n,\mathbb{R})\to T_I\operatorname{GL}(n,\mathbb{R})\to\operatorname{Lie}(\operatorname{GL}(n,\mathbb{R}))$给出同构关系}
\subsection{光滑向量场}
...
\end{example}
由\autoref{cor_LieGA_1} 和\autoref{the_Quat_1} 可证。
