...
2. 合力矩： 刚体合外力矩为零时，其角动量守恒\upref{AMLaw}，而刚体的角动量等于质心的角动量 $\bvec L_c =\bvec r_c\cross \bvec p_c$ 加上质心系中的角动量（\autoref{eq_AngMom_3}~\upref{AngMom}）。 当质心匀速直线运动或不动时 $\bvec L_c$ 不变，所以质心系中刚体的角动量也不变，所以刚体绕质心做匀速转动或不转动。 证毕。
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/32ff371ff5683be3.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7cm]{./figures/109dcde43a9bd97a.pdf}
