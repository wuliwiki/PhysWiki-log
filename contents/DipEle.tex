...
\footnote{本文参考 \cite{Brandsen}}本文使用原子单位制\upref{AU}． 在长度规范\upref{LenGau}下， 对于某种势能 $V$ 的束缚态 $\ket{\psi_a}$ 和 $\ket{\psi_b}$， 可以证明以下三种形式的\textbf{跃迁偶极子矩阵（transition dipole matrix）}相等．
