% Jordan 引理
% keys 复变函数|围道积分|约尔当引理|约当引理|若尔当引理|若当引理|Jordan's lemma|小圆弧引理|瑕积分|大圆弧引理
% license Xiao
% type Tutor

\pentry{留数定理\upref{ResThe}}{nod_cb7b}
...
\autoref{ex_JdLem_1} 是非常重要的例题，在我们严格讨论\textbf{狄拉克 delta 函数}\upref{Delta}时有很大作用。
