...
在\enref{单位制和量纲}{USD}这一节中我们提到了量纲式，并且给出了\autoref{def_USD_1}~\upref{USD}，本节将证明量纲式的通用表达式，并给出另外一种较为更“数学”的定义。本节的定理将给出一个极其重要的结论，它使得我们对物理规律有一个更深刻的认识。
\subsection{定义方程}
在\enref{单位制和量纲}{USD}这一节中，\autoref{ex_USD_1}~\upref{USD} 和\autoref{ex_USD_2}~\upref{USD} 提到了定义方程和终极定义方程，我们先给出它们的定义。
\begin{definition}{}
