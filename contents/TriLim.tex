...
在\autoref{TriLim_fig1}  所示的惯性坐标系 $XOY$ 中，天体A和天体B距离为 $R$ ，质量分别为 $M_1$ 和 $M_2$，总质量为 $M$，原点 $0$ 为该二体系统的质心。记 $M_1=\mu M$，则 $M_2=(1-\mu)M$。由 “开普勒问题\upref{CelBd}” 中的结论可知，天体 A 和天体 B 的运动轨迹是坐标平面中两条相似的圆锥曲线。
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/TriLim_1.pdf}
