...
\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Three-body_problem}{相关页面}。}在中心力场问题中，只需把质点质量 $m$ 和位矢 $\bvec r$ 分别替换成约化质量 $\mu M$ 和相对矢量 $\bvec R$ 即可将单质点中心力场问题的规律拓展到\enref{二体系统}{TwoBD}。

在\autoref{fig_TriLim_1}  所示的惯性坐标系 $XOY$ 中，天体A和天体B距离为 $R$ ，质量分别为 $M_1$ 和 $M_2$，总质量为 $M$，原点 $0$ 为该二体系统的质心。记 $M_1=\mu M$，则 $M_2=(1-\mu)M$。由 “\enref{开普勒问题}{CelBd}” 中的结论可知，天体 A 和天体 B 的运动轨迹是坐标平面中两条等离心率（相似）的圆锥曲线。
\begin{figure}[ht]
\centering
...
在没有外力或外力矩的情况下，三体系统的总角动量和总机械能守恒。由于先前假设质点C的引入不影响原二体系统的运动，因此在限制性三体问题中，天体A和天体B的机械能及角动量依旧守恒，而质点C的机械能也守恒。但由于质点C单向地受到天体A和天体B的引力作用，质点C的角动量并不守恒。


以上的讨论中，并不要求天体A和天体B的距离 $R$ 和角速度 $\omega$ 在运动过程中为定值。换句话说，无论原二体系统的运动模式是何种圆锥曲线，以上的讨论都成立。
