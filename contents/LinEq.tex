...
正如你所知道的那样\upref{LinEqu}，线性方程组$\mat A \bvec x=\bvec y$可以有零个解（无解）、一个解（唯一解）或无数解；但不能有只有两个解，等等。
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/38d2c05356e76942.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/255bf563838943b5.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/02b592b5a6967062.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/2b9c479ecf562168.pdf}
...
\footnote{see also 《线性变换与矩阵的代数关系》一节的 \autoref{the_linmat_2}~\upref{linmat}}
