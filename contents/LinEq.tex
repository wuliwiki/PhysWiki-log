...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/LinEq_2.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/LinEq_3.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/LinEq_4.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/LinEq_1.pdf}
\caption{$Ax=b$ 的解} \label{LinEq_fig1}
\end{figure}

\addTODO{需要补充证明}%我不会证明QAQ

关于线性方程组的解，我们有如下定理。记m为$\mat A$的行数，n为$\mat A$的列数，r为$\mat A$的矩阵的秩\upref{MatRnk}。可参考\autoref{LinEq_fig1} 的分类。
