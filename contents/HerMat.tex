...
\pentry{对称矩阵\nref{nod_SymMat}}{nod_1390}

\subsection{厄米共轭}
我们把矩阵元可以取复数的矩阵叫做\textbf{复数矩阵}。 % \addTODO{这句话是不是应该在前面提一下。}
与矩阵转置（\autoref{eq_Mat_3}~\upref{Mat}）类似， 可以定义厄米共轭（Hermitian conjugate）操作：
...
\addTODO{对任意线性映射有 $\braket{u}{Av} = \braket{A\Her u}{v} = \braket{v}{A\Her u}$， 即 $\bvec u\Her \mat A \bvec v = \bvec v\Her \mat A\Her \bvec u$ （\autoref{eq_HerMat_2}）。 这可以看作厄米算符的等效定义， 在泛函分析中更有用。}
