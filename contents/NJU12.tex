...
\begin{figure}[ht]
\centering
\includegraphics[width=4cm]{./figures/NJU12_1.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7.5cm]{./figures/NJU12_2.pdf}
\caption{力学第二题图} \label{NJU12_fig2}
\end{figure}
3. 劲度系数为 $k$ 的弹簧两端连接质量为 $m_1$、$m_2$ 的两物体，系统置于光滑水平面上，求系统作相对振动时的圆频率．
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/NJU12_3.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/NJU12_4.pdf}
