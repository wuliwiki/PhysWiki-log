...
\pentry{二阶常系数非齐次微分方程\nref{nod_Ode2N}，简谐振子（经典力学）\nref{nod_SHO}}{nod_353a}
\subsection{结论}
...
my'' =  - \alpha y' - ky~.
\end{equation}
之所以设为正比，是因为所得方程是线性方程，便于求解。根据“ \enref{二阶常系数齐次微分方程}{Ode2N}”， 解特征方程 $m r^2 + \alpha r + k = 0$， 可得通解分为三种情况。
\begin{enumerate}
...
\end{equation}
这种情况下， 质点做振幅不断衰减的振动， 衰减系数 $r$ 与阻力系数成正比。 若令（见\enref{简谐振子}{SHO}的振动频率）
\begin{equation}
