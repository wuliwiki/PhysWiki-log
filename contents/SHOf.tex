...
\pentry{简谐振子\upref{SHO}，二阶常系数齐次微分方程的\upref{Ode2N}}
\subsection{结论}
...
其中 $\omega _0 = \sqrt{k/m}$ 为\bb{固有振动频率}（$\alpha  = 0$ 时的振动频率）为，$r$ 和 $\omega$ 满足
\begin{equation}
...
my'' =  - \alpha y' - ky
\end{equation}
之所以设为正比，是因为所得方程是线性方程，便于求解．根据二阶常系数齐次微分方程\upref{Ode2N}， 解特征方程 $m r^2 + \alpha r + k = 0$， 可得通解分为三种情况．
\begin{enumerate}
