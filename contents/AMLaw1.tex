...
\pentry{牛顿第二定律\upref{New3}，力矩\upref{Torque}}{nod_a697}
...
\subsubsection{证明}
我们来证明单个质点的角动量定理。 令质点的速度为 $\bvec v = \dv*{\bvec r}{t}$，加速度为 $\bvec a = \dv*{\bvec v}{t}$， 叉乘的求导法则（\autoref{eq_DerV_8}~\upref{DerV}） 与标量乘法求导类似， 牛顿第二定律\upref{New3}为 $\bvec F = m\bvec a$，两个同方向矢量叉乘为零，
\begin{equation}
\ali{
