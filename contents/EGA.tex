...
\footnote{ A.Zee,Einstein Gravity in a Nutshell.}由“电磁力和引力\upref{EleGra}”一节，我们得到了处于外场中粒子作用量的两种情况：
\begin{equation}
\begin{aligned}
...
物理学应当是粒子和场之间的共舞。场告诉粒子如何运动，粒子反过来产生场。我们已经在“电磁力和引力\upref{EleGra}”一节中描述了粒子在场中的运动，本节将寻找主导场 $A_\mu(x),g_{\mu\nu}(x)$ 动力学的作用量。
