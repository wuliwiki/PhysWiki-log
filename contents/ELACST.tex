...
\pentry{杨氏模量、泊松比、剪切模量、广义胡克定律的基本形式\nref{nod_YoungM}}{nod_5bd7}

\textsl{小学二年级的我们}就已经知道"力使物体变形"。之前我们分别探讨了\enref{应力}{STRESS}与\enref{应变}{Strain}，现在我们要找到二者间的关系。这就是材料的本构关系。
...
如果往本构关系 \autoref{eq_ELACST_1} 中代入\enref{位移几何方程}{Strain}，那么本构关系化为
\begin{equation}
...
\subsection{简单的推导}
以$\varepsilon_{11}$为例，先根据单向拉伸的\enref{广义胡克定律}{YoungM}
...
而$\varepsilon_{12}$的情况遵循单向剪切的\enref{广义胡克定律}{YoungM}
$$
\begin{aligned}
