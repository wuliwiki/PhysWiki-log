...
\end{aligned}\end{equation}
第一个对易子是 $SU(2)$ 的李代数，这意味着\autoref{qed1_eq5} 中 $\bvec J$ 是角动量矢量（角动量李代数和它是同构的，这是角动量 2 （量子力学）\upref{QMAM}的基本知识），它也同样对应着\textbf{旋转}变换的生成元。而 $\bvec K$ 实际上对应着\textbf{推促}变换的生成元。
