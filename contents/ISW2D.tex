% 二维无限深势阱
% 薛定谔方程|无限深势阱|束缚态|分离变量法|算符|傅里叶级数

\pentry{无限深势阱\upref{ISW}， 分离变量法}% 未完成
...
V(x, y) =
\begin{cases}
0  & (0 \leqslant x \leqslant a \text{ 且 } 0 \leqslant y \leqslant b)\\
+\infty & (其他情况)
\end{cases}
\end{equation}
...
\end{cases}
\end{equation}
他们分别是一维简谐振子的定态薛定谔方程． 他们的各个束缚态波函数（\autoref{ISW_eq1}\upref{ISW}）分别为
\begin{equation}
