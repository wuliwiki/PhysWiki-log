...
\pentry{仿射空间\nref{nod_AfSp}，欧几里得矢量空间\nref{nod_EuVS}}{nod_3757}
有了\enref{欧几里得矢量空间}{EuVS}和\enref{仿射空间}{AfSp}之后，终于可以更加贴近于我们所处的3维物理空间。简单来说，欧几里得空间就是与欧几里得矢量空间相伴随的仿射空间。在它上面，可以获得高中时候早就熟知的各种几何图景，比如直角坐标系，线段，线线夹角等概念。不同的是，这里是更一般的空间，其维度不止于3维空间。
\subsection{欧几里得空间}
...
由\enref{矢量内积的性质}{EuVS}，距离函数有以下性质；
\begin{enumerate}
