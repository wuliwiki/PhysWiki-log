...
注意到分子的两项都是$e^x$式结构，因此设$f(x)=e^x$，原式化为$\lim_{x\to0} \frac{f(x^2)-f(x)}{x}$．根据Lagrange中值定理 $\exists \xi \in (x^2,x), f'(\xi)(x-x^2) = f(x)-f(x^2)$，所以原式化为 $\lim_{x\to0} \frac{f'(\xi)(x^2-x)}{x}$，即$\lim_{x\to0} e^\xi(x-1)=-\lim_{x\to0} e^\xi=-1$
\end{example}
