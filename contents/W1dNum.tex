...
\caption{运行结果， 动画见\href{https://wuli.wiki/apps/wavBC.html}{这里}． Dirichlet 边界反射后发生相位反转（半波损失）， Neumann 边界条件反射后无半波损失， Open 边界条件无反射．} \label{W1dNum_fig1}
\end{figure}
...
程序如下， 运行结果见\autoref{W1dNum_fig1}．
