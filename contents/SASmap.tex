...
由于对称群 $S_k$ 由对换生成（见\enref{对称群}{Perm}），我们可以把它简化为，交换任意两项 $v_i, v_j$ 后函数值保持不变：
\begin{equation}
...
%
% 如果对任意 $\bvec{v}_1,\cdots\bvec{v}_p \in V$ 及\enref{任意置换}{Perm} $\pi\in S_p$ ，都有
% \begin{equation}
...
% \end{equation}
% 其中 $\epsilon_\pi$ 是置换的\enref{符号（偶置换取1，奇置换取负）}{permu}。
% \end{definition}
