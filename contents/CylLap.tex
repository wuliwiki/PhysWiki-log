...
$Z(z)$ 的通解为 $C_1\E^{lz} + C_2 \E^{-lz}$，   $\Phi(\theta)$ 的通解为 $\E^{\I m\theta}$。   \autoref{eq_CylLap_7} 的解不能用有限的初等函数表示， \autoref{eq_CylLap_8} 为\enref{贝塞尔方程}{Bessel}的标准形式， 两个线性无关解是贝塞尔函数 $J_l(x), Y_l(x)$。
