...
\bvec u \vdot \bvec v = \sum_{i = 1}^N u_i v_i
\end{equation}
现在我们可以定义任意代数矢量 $\bvec v$ 的\bb{模长} 为（注意模长都是非负的实数）
\begin{equation}
\abs{\bvec v} = \sqrt{\bvec v \vdot \bvec v} = \qty(\sum_i \abs{v_i}^2)^{1/2}
\end{equation}
且定义若两个代数矢量内积为 0， 则它们互相\bb{正交}．

现在我们可以类比几何矢量定义代数矢量的\bb{正交归一基底}， 事实上在 “正交归一基底\upref{OrNrB}” 中， 我们并没有要求所有的矢量都是几何矢量， 而只要存在“ 内积”， “ 模长” 和“ 正交” 的概念．
