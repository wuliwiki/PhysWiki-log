...
时， 我们可以把它看做是一个几何矢量在一组（往往是正交归一的）基底上的展开\autoref{Gvec2_eq5}~\upref{Gvec2}． 这样就可以很自然地定义这种代数矢量的加法和数乘分别为\autoref{Gvec2_eq8}~\upref{Gvec2} 和\autoref{Gvec2_eq9}~\upref{Gvec2}．
