...
% license Xiao
% type Tutor
\pentry{组合\upref{combin}}{nod_a485}
\begin{issues}
...
由数学归纳法原理，\autoref{eq_BAHA_5} 得证。上面证明中 $C_n^m$ 为组合数\upref{combin}。
...
\pentry{矩阵指数\upref{MatExp}}{nod_8f1d}
...
\autoref{eq_BAHA_9} 对 $\tau$ 微分，并利用\autoref{eq_MatExp_3}~\upref{MatExp}，可得关于算子 $K$ 的微分方程：
