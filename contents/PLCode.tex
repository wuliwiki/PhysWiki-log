...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/89f02bd96ef7a283.png}
\caption{代码界面} \label{fig_PLCode_1}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/e59f3c701f3ab671.png}
\caption{线偏振} \label{fig_PLCode_2}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/3a952c6e16f29668.png}
\caption{右旋圆偏振（取 $\pi/2$）} \label{fig_PLCode_3}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/2506009caacc8b4a.png}
