...
\pentry{定态薛定谔方程\upref{SchEq}}{nod_25a3}

\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Finite_potential_well}{相关页面} 以及\cite{GriffQ}。}本文使用原子单位制\upref{AU}。 一维定态薛定谔方程\autoref{eq_SchEq_1}~\upref{SchEq}为
\begin{equation}
...
-\cot(k L/2) = \kappa /k~.
\end{equation}
% \addTODO{图未完成， \autoref{eq_FSW_2} 和\autoref{eq_FSW_3} 的图解超越方程，参考 griffiths 的图}
