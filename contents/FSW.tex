...
设 $z=\kappa L/2$，我们可以在同一坐标系中绘制 $-\cot(x)$ 和 $\sqrt{(z_0/z)^2-1}$ 的图像（$z_0=L\sqrt{2mV_0}/2$，表征了势阱“大小”），两个图像的每一个交汇点都对应着一个奇函数解．\autoref{FSW_fig3} 显示了 $z_0=7$ 的情况，可以看到两个图像共有 $2$ 个交点．

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/FSW_3.png}
\caption{方程 $-\cot z=\sqrt{(z_0/z)^2-1}$ 的解，$z_0=7$ 的情况（奇态）} \label{FSW_fig3}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/FSW_2.png}
\caption{方程 $\tan z=\sqrt{(z_0/z)^2-1}$ 的解，$z_0=7$ 的情况（偶态）} \label{FSW_fig2}
\end{figure}
