...
详情见文章商拓扑\upref{Topo7}

\addTODO{将商拓扑文章迁移到此处}

\subsubsection{积}

详情见文章积拓扑\upref{Topo6}

\addTODO{将积拓扑文章迁移到此处}

\subsubsection{不交并}

详情见文章\autoref{def_Topo9_3}~\upref{Topo9}
...
什么是带基点拓扑空间见\autoref{def_Topo9_2}~\upref{Topo9}

\subsubsection{一点并}

详情见文章\autoref{def_Topo9_1}~\upref{Topo9}
