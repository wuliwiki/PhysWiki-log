...
\pentry{转动惯量\upref{RigRot} }{nod_ea3f}

\subsection{平行轴定理}
\begin{figure}[ht]
\centering
\includegraphics[width=7 cm]{./figures/02f25785b31a1b14.pdf}
...
\end{equation}
由于质心轴经过刚体的质心， 上式最后一项中的求和为零（\autoref{eq_CM_7}~\upref{CM} ）， 而右边第二项恰好是 $I_0$， 右边第一项中 $\sum_i m_i = M$， 立即可得\autoref{eq_MIthm_1} 。 证毕。
...
\begin{figure}[ht]
\centering
\includegraphics[width=7cm]{./figures/823882312fb54491.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7cm]{./figures/cbe78e961b7499b8.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7 cm]{./figures/3a59da1b19df4526.pdf}
