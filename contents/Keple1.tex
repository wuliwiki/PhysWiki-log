...
\end{equation}
令 $\theta$ 为从 $\uvec A$ 转向 $\uvec r$ 的夹角， 则\autoref{Keple1_eq2} 变为
\begin{equation}
Ar\cos\theta = L^2 - mkr
\end{equation}
...
\subsection{证明（比耐公式）}
\pentry{开普勒问题\upref{CelBd}，圆锥曲线的极坐标方程\upref{Cone}，比耐公式\upref{Binet}， 二阶常系数非齐次微分方程的通解\upref{Ode2N}}

将平方反比力 $F(r) = -k/r^2$ 代入比耐公式
\begin{equation}
