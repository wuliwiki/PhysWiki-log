...
高斯单位制是在 \enref{CGS 单位制}{CGS}的基础上添加了一些电磁学相关的单位。以下先来定义各个物理量的转换常数， 
已知 CGS 的转换常数为
...
\end{equation}
若采用 2020 年 5 月以前的\enref{国际单位标准}{SIunit}，数值上等于 $10^{-4} c_{s}$， $c_{s}$ 是国际单位的光速。
...
\end{equation}
真空中的\enref{平面电磁波}{VcPlWv}若用高斯单位表示， 有 $E_0 = B_0$。
\begin{equation}
