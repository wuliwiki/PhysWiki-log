...
理论上也可以把演化子划分成两项 $\exp(-\I H_1 \Delta t)\exp(-\I H_0 {\Delta t})$ 但据说\autoref{eq_HyTDSE_2} 更精确。 至于相邻两步之间产生的 $\exp(-\I H_0 {\Delta t}/{2})\exp(-\I H_0 {\Delta t}/{2})$ 是否可以合并为 $\exp(-\I H_0 {\Delta t})$， 取决于所使用的算法这么做以后是否会引入额外误差。
