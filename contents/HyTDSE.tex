...
要使用速度规范（注意仍然是位置表象而不是动量表象）， $H_0$ 算符的计算是一样的， 唯一不同的是把 $\bvec E\vdot \bvec r$ 换成了 $\bvec A\vdot \bvec p$。 \autoref{eq_SphNab_5}~\upref{SphNab}。
...
\begin{equation}
\begin{aligned}
&\quad\mel{\frac{\psi_{l',m}}{r}Y_{l,m}}{\cos\theta\pdv{r}}{\frac{\psi_{l',m}}{r}Y_{l',m}}\\
&= \mel{\frac{\psi_{l',m}}{r}Y_{l,m}}{\cos\theta}{\frac{1}{r}\dv{\psi_{l',m}}{r}Y_{l',m}}
-\mel{\frac{\psi_{l',m}}{r}Y_{l,m}}{\frac{1}{r}\cos\theta}{\frac{\psi_{l',m}}{r}Y_{l',m}}\\
&= \mel{\frac{\psi_{l',m}}{r^2}}{\dv{r}}{\psi_{l',m}}\mel{Y_{l,m}}{\cos\theta}{Y_{l',m}}
-\mel{\frac{\psi_{l',m}}{r}}{\frac{1}{r}}{\frac{\psi_{l',m}}{r}}\mel{Y_{l,m}}{\cos\theta}{Y_{l',m}}~.
\end{aligned}
\end{equation}
所以\autoref{eq_HyTDSE_25} 的第一项实际上需要拆分成两项， 没有导数的那个合并到第二项中去。
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/27c3312e25e17bce.png}
