...
\pentry{类氢原子的定态波函数\upref{HWF}， Wigner 3j 符号\upref{ThreeJ}}{nod_456b}
...
\subsection{算符拆分}
\pentry{算符的指数函数、波函数传播子\upref{OpExp}}{nod_60f3}
...
\subsection{网格和演化算法}
\pentry{Crank-Nicolson 算法（一维）\upref{CraNic}}{nod_5b3a}
...
\pentry{平面波的球谐展开\upref{Pl2Ylm}}{nod_32c4}
...
\pentry{速度规范\upref{LVgaug}}{nod_e7b3}
...
\begin{equation}\label{eq_HyTDSE_13} % 和 Qprop 论文中一样
