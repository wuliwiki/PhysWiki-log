...
\item \verb|MinGW instellation manager| 是一个 GUI 界面可以下载安装编译好的 mingw 程序。 例如安装 \verb|mingw32-make|， 安装以后就和 \verb|make| 的用法一样。 注意该 manager 并不是一个通用的包管理软件， 里面的包基本还是围绕 GCC 的。
