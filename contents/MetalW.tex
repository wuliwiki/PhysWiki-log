...
\pentry{电场波动方程\upref{EWEq}}{nod_9ae8}
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/35784262b6b7375d.pdf}
\caption{导体中的平面电磁波示意图。注意它与真空电磁波\upref{VcPlWv}的差异（衰减、电场磁场不同相）} \label{fig_MetalW_1}
\end{figure}
