...
\pentry{刚体的平面运动方程\nref{nod_RBEM}， 柯尼希定理\nref{nod_Konig}}{nod_c2ad}

如果我们把\enref{刚体}{RigBd}看作质点系， 那么系统中任意两个质点间距离保持不变， 我们可以假设这些质点之间以不可伸长的轻杆相连， 使它们不能相对运动。

\subsection{平动动能与转动动能}

刚体的转动动能等于 $1/2$ 瞬时转轴的角速度平方乘以关于该轴的\enref{转动惯量}{RigEng}。平动动能等于质心的等效动能。
...
% \begin{example}{}
% 我们还可以从能量的角度来分析\autoref{ex_RBEM_1}， 
% \end{example}
