...
\begin{example}{理想的例子}%矩阵乘积的迹不可拆分，故删除。
...
\subsection{子李代数的直和}
\pentry{直和（线性空间）\nref{nod_DirSum}}{nod_3fa1}
\addTODO{如果单独开新文章的话应该加上\enref{外直和}{DirSum}，和内外半直和}
...
和\enref{单群}{SemGrp}类似，我们可以定义单李代数：
...
如果李代数 $\mathfrak{g}$ 能被表示成它的单子代数的\enref{直和}{DirSum}，我们就称之为\textbf{半单李代数（semi-simple Lie algebra）}，
\end{definition}
