...
f(x) = \sum\limits_{n =  - \infty }^{ + \infty } {{c_n}\exp \left( \I\frac{n\pi }{l}x \right)}  
\end{equation}
其中
 \begin{equation}\label{FSExp_eq2}
{c_n} = \frac{1}{{2l}}\int_{ - l}^l  f(x)\exp \left( -\I\frac{n\pi }{l}x \right)\D x 
\end{equation}
...
{f_n}(x) = \exp \left( \I\frac{n\pi }{l}x \right) \quad{n \in N}
\end{equation} 
定义复函数 $f(x)$, $g(x)$ 的点乘为
\begin{equation}
