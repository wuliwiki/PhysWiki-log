...
\item "Nobel Prize in Physics 1949". Presentation Speech. The Noble Foundation. 1949.
\item H. Yukawa, (1935)
\item G. Gamow, (1961)
...
\item C. Amsler et al. (2008): Particle listings – $B^\pm_c$
\item C. Amsler et al. (2008): Particle listings – $\rho$
\item C. Amsler et al. (2008): Particle listings – $\omega(782)$
\item C. Amsler et al. (2008): Particle listings – $\varphi$
\item C. Amsler et al. (2008): Particle listings – $J/\Psi$
\item C. Amsler et al. (2008): Particle listings – ϒ(1S)
\item C. Amsler et al. (2008): Particle listings – $K^*$(892)
\item C. Amsler et al. (2008): Particle listings – $D^{*\pm}$(2010)
\item C. Amsler et al. (2008): Particle listings –$D^{*0}$(2007)
\item C. Amsler et al. (2008): Particle listings – $D^{*\pm}_s$
\item C. Amsler et al. (2008): Particle listings – $B^*$
\item C. Amsler et al. (2008): Particle listings – $B^*_s$
\end{enumerate}
\subsection{参考文献}
[1]D. Griffiths (2008).
