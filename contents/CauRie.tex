...
对于实变量的函数， 只有正负两个方向趋于零， 所以复变函数可导的条件更复杂． \autoref{CauRie_eq4} 会让我们联想到二元函数的方向导数\upref{DerDir}， $x$-$y$ 平面就是复平面， 但由于\autoref{CauRie_eq4} 中的除法是复数的除法， 所以它比方向导数\upref{DerDir}要更复杂一些， 但大体上是相似的．
