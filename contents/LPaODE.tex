...
\end{theorem}
 ...
 \begin{corollary}{}\label{LPaODE_cor1}
 若
 \begin{equation}
 \varphi_i(x_1,\cdots,x_{n+1})=C_i,\quad i=1,\cdots,n
 \end{equation}
...
\begin{equation}\label{LPaODE_eq7}
...
\end{equation}
由于 $x_1,cdots,x_n,\varphi$ 可取任意值，于是 $\omega$ 恒满足上式，由\autoref{LPaODE_the1} ，解这个偏微分方程可以化为求它对应的常微分方程组。若求得 $\omega$，带入\autoref{LPaODE_eq7} ，就确定了 $\varphi$。

\textbf{注意：}由\autoref{LPaODE_cor1} ，偏微分方程的一般解含有任意函数，而常微分方程的解只有任意常数出现。
