...
根据理想气体状态方程\upref{PVnRT}， 我们可以得知给定量的理想气体的宏观状态只有两个自由度\upref{DoF}。 在\autoref{ex_StaPro_2}~\upref{StaPro} 中我们说到可以在压强 $P$， 体积 $V$， 温度 $T$ 等宏观量中任取两个来作为该系统的状态量， 完全确定系统的宏观状态。 而最常见的作法是取压强和体积 $P,V$。 于是自然地， 我们可以用一个二维直角坐标系 $P$-$V$ 中的一点来描绘理想气体某时刻的状态及其变化， 称为\textbf{压强体积图}。 该平面就是理想气体的（宏观）状态空间。 注意在讨论 $P$-$V$ 上的状态变化时， 我们往往假设气体始终处于准平衡的状态。

对于其他的气体模型（如范德瓦尔斯气体\upref{Vand}）， 虽然状态方程与理想气体不同， 但以上讨论仍然成立， 所以同样可以用 $P$-$V$ 图描述其状态的变化。
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/f6dbbaf5b6b26532.png}
\caption{理想气体的等温线} \label{fig_PVgraf_4}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/1af2c17ea06810d2.png}
...
现有一个\textbf{体积 $V$ 可变}的容器，在容器壁上可以安装探测器来测量内部气体的\textbf{压强 $P$}。只要气体处于平衡态\upref{TherEq}，气体的压强就处处相等。现在我们考虑这样一个问题——改变容器的体积，需要对容器做多少功\upref{Fwork}（或者容器对外界做多少功）？
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/01008812b1a56b8b.pdf}
...
\begin{figure}[ht]  
\centering
\includegraphics[width=5cm]{./figures/d03a67bed5a3b79d.pdf}
