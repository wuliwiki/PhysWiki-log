...
\pentry{单纯剖分（三角剖分）\upref{Traglt}，群同态\upref{Group2}}{nod_799a}
...
由\autoref{lem_SHCal_1} 和\textbf{群同态基本定理}（\autoref{exe_Group2_1}~\upref{Group2}），$H_0(K)=Z_0(K)/B_0(K)=Z_0(K)/\opn{ker}\epsilon=\opn{Im}\epsilon=\mathbb{Z}$。
