...
我们用\autoref{Sca1D_eq3}~\upref{Sca1D} 计算波函数的含时演化． 另外我们用离散的 $k_i$ 代替连续的 $k$， 对 $k$ 积分改为对 $i$ 求和并乘以 $\Delta{k}$． 另一种可能更常见的数值解 TDSE 算法见 “Crank-Nicolson 算法解一维含时薛定谔方程（Matlab)\upref{CraNic}”．
