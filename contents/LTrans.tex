...
我们假设\autoref{eq_LTrans_2} 中的数都是实数， 那么我们可以把 $(x_1, \dots, x_n)$ 和 $n$ 维空间中的几何矢量\upref{GVec}意义对应， 即把它们看作是 $X$ 空间中矢量 $\bvec x$ 的 $n$ 个坐标。 同理我们把 $(y_1, \dots, y_n)$ 看作是 $m$ 维空间 $Y$ 中的几何矢量 $\bvec y$ 的坐标。
