...
为了方便讨论， 我们以下假设蒸汽为理想气体\upref{PVnRT}． 在常温常压（或更低温低压）下这一般是近似成立的， 但在高温高压下假设会失效．

\begin{exercise}{水蒸气的质量}
根据\autoref{VaporP_fig2} 和理想气体状态方程\autoref{PVnRT_eq1}\upref{PVnRT}， 求 25°C 时一立方米纯水蒸气的质量．
% 未完成
\end{exercise}
...
我们接下来讨论容器中除了某种液体及其蒸汽外， 还有另一种气体的情况． 以水， 水蒸气和干燥的空气为例． 如果将两种气体都视为理想气体， 那么两种气体的总压强可以根据分压定律来计算， 即水蒸气单独存在时的压强加上空气单独存在时的压强． 另外， 假设空气分子不溶于水且不与水分子发生任何反应， 则水蒸气的分压仍然是 $P_{H2O}(T)$．
...
另一方面， 空气中绝对湿度常常低于\autoref{VaporP_eq1} 的值， 即水和水蒸气处于不平衡的状态． 这是因为地表的水（江湖海， 湿润的土壤等）蒸发的速度有限， 大气并不是长期处于恒温恒压状态．
