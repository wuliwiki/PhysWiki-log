...
\pentry{理想气体状态方程\upref{PVnRT}}{nod_b929}
...
\subsubsection{热力学证明}
\pentry{相变平衡条件\upref{PhEquv}，相变的热力学量变化\upref{PTTVC2}}{nod_6dd5}
假设一个大气压与一定温度下，液态水与水蒸气达到平衡，此时水的蒸气压即为饱和蒸气压 $p^*$。由相变平衡条件\upref{PhEquv}， 水蒸气的化学势应该等于液态水的化学势。我们以上说的“熵最高”原则，已经蕴含在“相变平衡条件”所给出的化学势条件中。
$$
\mu_g = \mu_l~,
$$
...
\subsection{混合气体}
\pentry{理想气体分压定律\upref{PartiP}}{nod_6ce1}
