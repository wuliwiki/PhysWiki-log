...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/463d5eeb573bf9bd.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=11cm]{./figures/886a87ef4fc50a30.png}
\caption{编译} \label{fig_cublas_1}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=11cm]{./figures/356872cf5ca18c98.png}
