...
\end{equation}
其中 $v_g = \dv*{\omega}{k} = k$ 是波包的速度， 即群速度\upref{GroupV}． 确切来说， 是\textbf{波峰}移动的速度． 该式反应了波峰随时间的变化轨迹． 同样， 如果给 $\varphi$ 加上一个相移 $\phi$， 可得\autoref{tDelay_eq2}． 可见， 驻相法不仅可以得到相对延迟， 还可以得到\autoref{tDelay_eq3} 的波峰的绝对延迟
