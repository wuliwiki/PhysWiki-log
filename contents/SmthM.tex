% 光滑映射（简明微积分）
% keys 光滑函数|解析函数|smooth|smooth function|smooth map|analytical function|微分|欧几里得空间
% license Xiao
% type Tutor

\pentry{线性映射\nref{nod_LinMap}，矢量的导数\nref{nod_DerV}，偏导数（简明微积分）\nref{nod_ParDer}}{nod_c314}
%预备知识需要创作+整合
%注意，缺失了欧几里得空间的相关文章。思考该如何撰写和整理相关概念。
