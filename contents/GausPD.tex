...
正态分布中， $x$ 落在区间 $[\mu-a,\mu+a]$ 内的概率可以用\enref{误差函数}{Erf} $\erf$ 表示：
\begin{equation}
% 已数值验证
...
\hline
$1-\int_{-x}^x f(t)\dd{t}$ & 0.3173 & 4.550e-2 & 2.700e-3 & 6.334e-5 & 5.733e-7 & 1.973e-9 & 2.56e-12 & 1.24e-15 \\
\hline
\end{tabular}
\end{table}
...
现在我们补充两个积分，由\enref{换元积分法}{IntCV}（$x=\sqrt{t}$）以及 $\Gamma$ 函数\upref{Gamma} 的性质得
