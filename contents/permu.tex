...
\begin{theorem}{}\label{permu_the2}
...
\begin{theorem}{置换的奇偶性}\label{permu_the1}
...
\begin{definition}{}\label{permu_def1}
...
由\autoref{permu_lem1} 、\autoref{permu_the1} 和\autoref{permu_def1} 可知，$S_n$的全体偶置换构成一个正规子群。

\begin{definition}{交错群}\label{permu_def2}
