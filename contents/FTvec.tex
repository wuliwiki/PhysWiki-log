...
在 “傅里叶变换与连续正交归一基底\upref{COrNoB}” 中， 我们已经用矢量空间和连续基底的概念来理解傅里叶变换， 但我们把函数看作矢量本身。 而在本文中， 我们再次用另一种方法理解傅里叶变换， 即把函数看作是矢量的坐标而不是矢量本身。 注意这种理解和 “连续基底” 的概念一样， 并不十分严谨， 但对于理解量子力学中的 “位置表象和动量表象”%\addTODO{链接}
却十分有用。
