...
% license Xiao
% type Tutor
\pentry{基本知识（常微分方程）\nref{nod_ODEPr}}{nod_fc92}
\footnote{参考斯米尔诺夫《高等数学》第2卷第1分册}下面将介绍常微分方程的一般积分，它是常微分方程解的一般形式。物理学中“运动积分”（或“运动方程的积分”）（\enref{运动积分}{motint}）和“循环积分”中的“积分”之所以叫“积分”的原因，可以在本文得到解答。
