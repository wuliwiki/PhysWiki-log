...
\pentry{定积分\nref{nod_DInt}，上确界与下确界\nref{nod_SupInf}}{nod_d174}
“定积分\upref{DInt}"里给出了定积分的定义，并且强调了该定义只适用于有解函数的情况。也就是说定积分的存在是有条件的，所以自然而然就出现这样的疑问：是否有一般的办法断定积分是否存在？这就是本文要完成的任务。
\subsection{达布和}
...
%\textbf{注意：以下内容属于可积函数的内容，应移到可积函数文章。}
