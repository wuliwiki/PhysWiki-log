...
\begin{itemize}
\item \enref{SymPy}{SymPy}
\item \enref{SageMath}{SageNt} 集成了众多开源库， 打算代替 Mathematica 等。 见 \href{https://github.com/sagemath/sage/}{github 页面}。 可以参考一下它用到了哪些库。
\item  \enref{Mathematica}{Mma} 和 \href{https://maxima.sourceforge.io/}{Maxima} 基本是最快的， 后者是开源的（用 Common Lisp 写的）
\item \href{http://www.axiom-developer.org/}{Axiom} 1971 开始开发，投入约 300 人年（Lisp 和 C）
\item \enref{JuliaSymbolics}{JulSym}
