...
\subsection{解析分析}
即使能轻易得到数值解， 解析的分析也能帮我们更好地理解散射问题（或者任何问题）． 和 “一维自由粒子（量子）\upref{FreeP1}” 中的过程类似， 分离变量法可以得到\autoref{Sca1D_eq1} 的通解（\autoref{TDSE11_eq4}~\upref{TDSE11}）． 首先看定态薛定谔方程定态薛定谔方程
