...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/a7fc67871933ca9e.png}
\caption{$20\times 20$ 的五对角矩阵} \label{fig_NLinE3_1}
\end{figure}
这一节我们就来探究一下这张图片的由来，以及它在解线性方程组中的重要意义。

事实上，这张图片是一个 $20\times20$  的\textbf{五对角矩阵（pentadiagonal matrix）}。而产生这个矩阵的问题，则是求解一个跳板的弹性形变，也就是所谓的\href{https://en.wikipedia.org/wiki/Euler–Bernoulli_beam_theory}{欧拉—伯努利梁方程}。
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/57a0be099925b23d.png}
