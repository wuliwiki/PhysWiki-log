...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/RigBMa_1.png}
\caption{\verb|intersect| 测试结果}} \label{RigBMa_fig1}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/RigBMa_2.png}
\caption{\verb|alphaShape| 测试结果}} \label{RigBMa_fig2}
\end{figure}
