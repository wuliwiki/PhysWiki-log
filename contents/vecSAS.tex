...
$k$ 维向量空间 $V$ 的 $n$ 阶张量幂空间 $V^{\otimes n}$ 上存在一个 $n$ 阶对称群 $S_n$ \upref{Perm}的群作用：
\begin{equation}
\begin{aligned}
...
\addTODO{交错性（$v_i = v_j \implies v_1 \otimes \cdots \otimes v_n = 0$）与反对称性等价}
