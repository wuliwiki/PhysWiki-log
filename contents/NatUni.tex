...
\pentry{原子单位制\upref{AU}}{nod_9ffb}
...
\begin{table}[ht]
\caption{自然单位制的换常数，括号表示最后两位的误差， 不带括号的是精确值。 参考 “物理学常数\upref{Consts}”。}\label{tab_NatUni_1}
\begin{tabular}{|c|c|c|}
\hline
...
\subsection{推导}
我们先来确定三个基本转换常数 $\beta_x, \beta_m, \beta_t$。 在 “原子单位制\upref{AU}” 的一开始， 为了使 $\beta_L = \hbar$ （也就是所谓的 “令 $\hbar = 1$”）， 我们得到（\autoref{eq_AU_6}~\upref{AU}）
...
\subsection{电磁常数}
\pentry{洛伦兹力\upref{Lorenz}}{nod_a608}
