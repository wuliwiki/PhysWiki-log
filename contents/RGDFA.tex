...
\begin{figure}[ht]
\centering
\includegraphics[width=4cm]{./figures/RGDFA_1.pdf}
\caption{轻绳提供沿绳方向的力} \label{RGDFA_fig1}
\end{figure}
拉紧的轻绳只能受拉而不能受压。
...
\begin{figure}[ht]
\centering
\includegraphics[width=4cm]{./figures/RGDFA_2.pdf}
\caption{轻杆提供的力不一定平行于杆} \label{RGDFA_fig2}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/RGDFA_3.pdf}
\caption{接触面的支持力总是垂直于公切线} \label{RGDFA_fig3}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/RGDFA_5.pdf}
\caption{小车提供垂直接触面的力} \label{RGDFA_fig5}
\end{figure}
小车可以为与其相连的杆提供一个垂直接触面向上的支持力，但是不能提供一个垂直表面向下的拉力；如果接触面是粗糙的，那还能提供一个平行于接触面的静摩擦力。
\subsubsection{铰链模型 Fixed Hinge}
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/RGDFA_6.pdf}
\caption{铰链提供任意方向的力} \label{RGDFA_fig6}
\end{figure}
铰链可以为与其相连的杆提供一个任意方向的力，但是不能提供力偶。在初步的受力分析中，力的方向不能确定，因此可以先记为两个互相垂直的分力。
\subsubsection{钉子模型 Fixed Rod}
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/RGDFA_7.pdf}
\caption{钉子提供力偶与任意方向的力} \label{RGDFA_fig7}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/RGDFA_8.pdf}
...
\caption{先把系统视作一个整体，进行受力分析。例如，此处灯泡所受的外力是向下的重力与电线向上的拉力} \label{RGDFA_fig16}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/RGDFA_12.pdf}
\caption{“标注主动力”} \label{RGDFA_fig12}
\end{figure}
\item 并根据约束条件标注约束力（注意到，此时系统中其他组件对该组件的约束力不能再被忽视），
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/RGDFA_13.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/RGDFA_9.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/RGDFA_10.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/RGDFA_11.pdf}
