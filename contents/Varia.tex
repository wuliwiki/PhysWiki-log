...
\pentry{绝对极值与相对极值（变分学）\nref{nod_AbPol}}{nod_7332}
...
\subsection{变分}\label{sub_Varia_1}
...
\end{equation}
由拉格朗日微分中值定理\autoref{the_MeanTh_2}~\upref{MeanTh}
\begin{issues}
\issueOther{这里应该是多元函数的拉格朗日中值定理，应完善相关文章插入引用}
\end{issues}
...
因为对 $a\leq x\leq b$ ，总假设曲线之间的距离是一级的\autoref{def_AbPol_1}~\upref{AbPol}。有
\begin{equation}
\begin{aligned}
