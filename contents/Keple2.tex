...
\begin{figure}[ht]
\centering
\includegraphics[width=4.5cm]{./figures/b58d23c9b1b309e0.pdf}
...
\subsection{第三定律}
我们要试图找到开普勒问题中椭圆轨道的周期与其形状大小之间的关系。 一个直接的思路就是用椭圆的面积除以开普勒第二定律中的面积变化率得到周期。 用\autoref{eq_CelBd_10}~\upref{CelBd} 将\autoref{eq_Keple2_3} 中的角动量用轨道参数 $a,b$ 表示， 有
\begin{equation}
