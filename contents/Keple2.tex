...
\subsection{第三定律}
我们要试图找到开普勒问题中椭圆轨道的周期与其形状大小之间的关系． 一个直接的思路就是用椭圆的面积除以开普勒第二定律中的面积变化率得到周期． 在证明开普勒第二定律时， 我们得出了面积变化率和角动量成正比（\autoref{Keple2_eq3}\upref{Keple2}）， 再通过\autoref{CelBd_eq10}\upref{CelBd} 将角动量用轨道参数 $a,b$ 表示， 有
\begin{equation}
