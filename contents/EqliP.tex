...
本节介绍自治系统（\autoref{def_ODEPr_2}）解的分类。概括来说，自治系统的解（或\enref{轨线}{AuSy}）有三种情形：
\begin{enumerate}
...
闭集是集的任意收敛点都在集中的集合（\autoref{def_realat_1}）。所以要证 $F$ 闭，只需对任意收敛于 $T_0$ 的周期序列 $T_1,\cdots, T_m,\cdots$ ，证明
\begin{equation}
