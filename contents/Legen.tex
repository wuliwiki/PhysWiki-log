% 勒让德多项式
% keys 勒让德方程|正交归一性|罗德里格斯公式|勒让德多项式
% license Xiao
% type Tutor

\pentry{二阶常系数齐次微分方程\nref{nod_Ode2}}{nod_50b6}
...
\end{equation}
其中 $[x]$ 是向下取整函数。 当 $x$ 是整数， $[x] = x$， 当 $x$ 是非整数， $[x]$ 是小于 $x$ 的最大整数。 % \addTODO{链接}
...
\enref{傅里叶变换}{FTExp}（$j_l$ 是\enref{球贝塞尔函数}{SphBsl}）
