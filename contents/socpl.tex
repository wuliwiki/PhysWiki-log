...
\end{equation}
注意这里比文章“狄拉克方程的非相对论近似”\upref{DiracB}中求解泡利方程的\autoref{eq_DiracB_4}~\upref{DiracB}的推导多保留了一阶近似。让我们继续推导前进，将\autoref{eq_socpl_1} 代入\autoref{eq_socpl_2} 的第一行，可以得到
\begin{equation}
