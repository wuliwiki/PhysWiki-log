...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/PLREMW_1.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/PLREMW_2.pdf}
\caption{线偏振。右侧图像为俯视图，下同} \label{PLREMW_fig2}
\end{figure}

\subsubsection{$\varphi_0=\frac{\pi}{2}n, n=\pm1,\pm3,\pm5,...$：圆偏振}
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/PLREMW_3.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/PLREMW_4.pdf}
