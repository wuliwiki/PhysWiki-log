...
\pentry{欧几里得空间中的曲线\upref{eucur}，张成空间\upref{VecSpn}}{nod_f3dc}
...
为了得到单位切向量，我们可以用切速度除以切速度的大小来获得：$\frac{\dd}{\dd t}f(t)/\abs{\frac{\dd}{\dd t}f(t)}$。但更简单的方法是，令切速度的大小恒为 $1$，或者说只讨论切速度大小恒为 $1$ 的情况，即弧长参数曲线\autoref{def_eucur_1}~\upref{eucur}；我们将用字母 $s$来表示弧长参数。
