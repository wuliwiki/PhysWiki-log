...
\subsection{万有引力势能}
\pentry{力场\ 势能\upref{V}， 球坐标系中的梯度算符}
...
其中第二步是因为
\begin{equation}
\vec F(\vec r) \vdot \dd{\vec r} = F(r)\uvec r \vdot \dd{\vec r} = F(r)\uvec  r \vdot (\dd{r} \uvec  r + r\dd{\theta} \uvec \theta ) = F(r) \vdot \dd{r}
\end{equation}
