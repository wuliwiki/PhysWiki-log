...
% license Xiao
% type Tutor
\pentry{热平衡、热力学第零定律\upref{TherEq}}{nod_42d0}
...
\end{aligned}
\end{equation}
这就是著名的 \textbf{斯特藩—玻尔兹曼（Stefan-Boltzmann）定律}\upref{SteBol}，它指出了单位面积上辐射功率与辐射场能量密度之间的关系。对频率积分就可以得到总的辐射功率和辐射场能量密度之间的关系
\begin{equation}
...
\pentry{盒中的电磁波\upref{EBBox}}{nod_5437}
