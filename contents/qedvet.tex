...
\pentry{QED的重整化理论-电子自能和光子自能的单圈修正\nref{nod_qedlop}，Ward-Takahashi 等式\nref{nod_ward}}{nod_ae47}
...
\end{equation}
类似\enref{电子自能和光子自能的单圈修正}{qedlop}中的讨论，我们先在 OS 重整化方案下进行讨论，用维数正规化处理发散积分。根据 OS 方案下的重整化条件，我们希望当电子光子外线在壳、且光子四动量为 $0$ 时，有
\begin{equation}
