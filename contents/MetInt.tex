...
\autoref{MetInt_fig1} ，\autoref{MetInt_fig10} \autoref{MetInt_fig15} 由atomsk与OVITO绘制。
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/MetInt_19.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/MetInt_20.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/MetInt_21.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MetInt_9.pdf}
\caption{置换大原子使周围原子偏离平衡位置，并造成了内压应力} \label{MetInt_fig9}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/MetInt_11.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/MetInt_12.png}
\caption{孪晶界示意图。注意到孪晶界（红色线）两侧的原子排列位向（蓝色线）呈对称关系} \label{MetInt_fig12}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MetInt_22.png}
\caption{相界示意图。左右两部分是不同的相，因此晶体的成分、堆积方式可以不同。} \label{MetInt_fig22}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=4cm]{./figures/MetInt_16.png}
\caption{珠光体的层片结构示意图。图中两种颜色的部分代表两种相，它们的边界即为相界。} \label{MetInt_fig16}
\end{figure}
\end{example}

\subsection{宏观材料}\label{MetInt_sub1}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/MetInt_17.png}
