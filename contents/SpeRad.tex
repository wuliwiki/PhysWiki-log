...
对预解式 $(z-T)^{-1}$ 进行\enref{冯诺依曼级数展开}{BddRsv}, 可见谱集包含于圆 $|z|\leq\|T\|$ 内。 所以有 $r(T)\leq\|T\|$. 更精确的定理如下：
\begin{theorem}{}
...
可见， 谱半径的意义正如同数值幂级数的收敛半径， 而它的计算方法正如同\enref{柯西-阿达玛公式}{CHF}所揭示的那样。
