...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/3c41d1217dc56a53.pdf}
...
把波函数用\autoref{eq_ISW_1} 的基底展开， 是三角傅里叶级数的一个变形（详见\autoref{eq_FSTri_8}~\upref{FSTri}）， 虽然看上去少了 $\cos$ 基底， 但它的确是完备的。
