...
要证明这个定理可以将每个叉乘在各个基底上展开（\autoref{eq_Cross_2}~\upref{Cross}）。

\begin{exercise}{}
由叉乘的坐标定义（\autoref{eq_Cross_2}~\upref{Cross}） 证明\autoref{eq_TriCro_1}。
\end{exercise} 
...
\begin{figure}[ht]
\centering
\includegraphics[width=7cm]{./figures/c51bc5f244ed4cfb.pdf}
