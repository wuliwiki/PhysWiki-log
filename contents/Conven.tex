...
\subsubsection{通用规范}
\begin{itemize}
\item 如无声明默认使用最新国际单位制\upref{Consts}（2018 CODATA）， 若使用其他单位制， 要在每篇文章开头用脚注声明 “本文使用 xx 单位制”。 例如\enref{原子单位制}{AU}， 厘米—克—秒\upref{CGS}， 或高斯单位制\upref{GaussU}， 自然单位制\upref{NatUni}。
