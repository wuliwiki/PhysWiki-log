...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/f342974769d3183d.png}
\caption{程序运行结果， 动画见\href{https://wuli.wiki/apps/FFTplt.html}{这里}。 这里的曲线使用小时百科的图标\upref{xwLogo}。} \label{fig_FFTdrw_1}
\end{figure}
