...
若函数曲线在 $x$ 的某一开区间内的每一点都可导， 则这个区间上每一个 $x$ 对应一个导数．将其写成关于 $x$ 的函数 $g(x)$，  $g(x)$  就是该区间上的 \bb{导函数}． 通常将导函数记为以下的一种（后3种记号的来源见下文）
...
\rentry{基本初等函数的导数\upref{FunDer}，求导法则\upref{DerRul}，高阶导数 }
