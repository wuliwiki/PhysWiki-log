...
所以
\begin{equation}\ali{
\D z &= \pdv{f}{u}\left( {\pdv{u}{x}\D x + \pdv{u}{y}\D y} \right) + \pdv{f}{v}\left( {\pdv{v}{x}\D x + \pdv{v}{y}\D y} \right) \hfill \\
   &= \left( \pdv{f}{u}\pdv{u}{x} + \pdv{f}{v}\pdv{v}{x} \right)\D x + \left(\pdv{f}{u}\pdv{u}{y} + \pdv{f}{v}\pdv{v}{y}\right) \D y
}\end{equation}
