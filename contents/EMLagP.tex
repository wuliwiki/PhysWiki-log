...
\pentry{电磁场标势和矢势\nref{nod_EMPot}， 广义力\nref{nod_LagEqQ}， 欧拉—拉格朗日方程（经典力学）\nref{nod_Lagrng}， 哈密顿正则方程\nref{nod_HamCan}}{nod_ab5d}
...
\end{equation}
其中 $\Phi$ 和 $\bvec A$ 分别为点电荷所在位置的\enref{电磁标势和矢势}{EMPot}， $\bvec v$ 为点电荷的速度。
