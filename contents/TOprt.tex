...
\pentry{量子力学的基本原理（量子力学）\upref{QMPrcp}}{nod_1d70}
...
\end{equation}
因此，$\Omega$是一个\textbf{反厄米算符}（\autoref{def_QMPrcp_19}~\upref{QMPrcp}）。
...
如果哈密顿算符作为时间的函数$H(t)$，满足$H(t_1)H(t_2)=H(t_2)H(t_1)$，则可类比\autoref{exe_ODEa2_1}~\upref{ODEa2}，猜出形式解
