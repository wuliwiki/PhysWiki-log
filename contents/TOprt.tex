...
这里我们直接给出了调整量纲的常量$\hbar$。为什么是$\hbar$，而不是$h$或别的什么同量纲量呢？这个问题在\autoref{TOprt_sub1} 中解答。
...
如果哈密顿算符作为时间的函数$H(t)$，满足$H(t_1)H(t_2)=H(t_2)H(t_1)$，则可类比\autoref{ODEa2_exe1}~\upref{ODEa2}，猜出形式解
