...
\dv{\vec L}{t} = \vec M
\end{equation}
即系统的角动量对时间的变化率等于所受外力的合力矩．系统可以包括任意选定的物体，系统外物体对系统内物体的力叫做\textbf{外力}，系统内物体的相互作用力叫做\textbf{内力}．
...
\begin{equation}
\vec r_k\cross\vec \alpha(\vec r_k - \vec r_l) + \vec r_l\cross\alpha(\vec r_l - \vec r_k)
\end{equation}
