...
\subsection{文件版本管理}
使用 GitHub Desktop， 用 MacroUniverse/PhysWiki 项目管理所有文件， 每次 commit 尽量先完成以下检查．
\begin{itemize}
\item 确保所有文档可以顺利编译．
