...
本词条需要与 LaTeX 源码对照阅读， 请使用\link{在线编辑器}{http://wuli.wiki/editor}中打开．
...
其他不支持的代码也可以使用 lstlisting 环境， 但不会有高亮， 若以后支持了会自动高亮
\begin{lstlisting}[language=julia]
a = rand(3, 3)
c = 1 + 2im
b = c * a
\end{lstlisting}
如果不希望高亮， 则省略 lstlisting 环境的方括号即可．
...
网址的超链接如\link{本书网站}{http://wuli.wiki}．
