...
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/2e209abd93466fa7.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/51f337c7188b8109.png}
\caption{执行 $1\sim3$ 次操作} \label{fig_List_2}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/9d9b93104e5e4475.png}
\caption{执行 $4\sim7$ 次操作} \label{fig_List_3}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/ecbcbaff44c40f16.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/eb356286d9dc33c0.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/1a265282ba1d543b.png}
