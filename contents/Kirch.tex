...
若 $q>0$， 则说明有正电荷会累积于该节点， $q < 0$ 表示负电荷会累积于节点。 在讨论电路时， 我们一般假设任意一点不存在\enref{净电荷}{Circ}，所以 $q$ 和 $I$ 都恒为零。
...
设想在 $A $、$B $ 之间接入端电压为 $U $ 的无内阻电源使成完整的电路，用基尔霍夫方程组求出从 $A $ 流进的电流 $I$，则比值 $U/I$ 便是 $A$、$B$ 之间的总电阻。把\enref{惠斯通电桥}{WheBrg}中的 $I_\mathrm{G}$、$R_\mathrm{G}$ 分别改为 $I_5,R_5$，即可得出答案。求解可得 $I=U/32\Omega$，即 $A$、$B$ 之间的总电阻为 $32\Omega$。
\end{example}
