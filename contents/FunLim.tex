...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/FunLim_5.png}
\caption{对于一个$\epsilon$，存在对应的$X$．仿自\cite{Thomas}} \label{FunLim_fig5}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/FunLim_6.png}
\caption{对于任意一个$\epsilon$，都存在对应的$X$．仿自\cite{Thomas}} \label{FunLim_fig6}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/FunLim_7.png}
\caption{对于一个$\epsilon$，存在对应的$\delta$.仿自\cite{Thomas}} \label{FunLim_fig7}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/FunLim_8.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=4cm]{./figures/FunLim_3.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/FunLim_9.png}
