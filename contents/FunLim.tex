...
\pentry{数列的极限（简明微积分）\upref{Lim0}， 充分必要条件\upref{SufCnd}， 函数（高中）\upref{functi}}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/85db20312102f966.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/87de786c69964477.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/5fbdc893bb0c56d0.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=12cm]{./figures/a60dec43598ae2cd.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/09e53d27efa28c31.pdf}
...
这是因为定义中只考虑 $x$ 慢慢接近 $x_0$ 的过程， 而不考虑 $x = x_0$ 的情况。 即使我们把这点从函数定义域中挖去， 极限是否存在， 以及极限值是多少都不会被改变。 例如在\autoref{ex_FunLim_1} 与在 “小角极限\upref{LimArc}” 中会看到， 虽然 $\sin x/ x$ 在 $x = 0$ 处没有定义， 但其极限却等于 $1$。

\begin{example}{可去间断点}
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/52ccaee333ec35a5.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/828c4b18b218560f.pdf}
