...
\pentry{粒子交换算符\upref{ExchOp}}{nod_1c23}
...
由\autoref{eq_symetr_5} 的启发， 我们可以尝试改变\autoref{eq_symetr_1} 或\autoref{eq_symetr_2} 中一些项的正负号来达到反对称化。 事实上行列式的定义\upref{Deter}中已经给出了我们需要规则， 即使用逆序数的奇偶性来决定正负号。 对称化的结果可以用行列式记为
