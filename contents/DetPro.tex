...
以下是行列式常见的性质， 我们从定义出发容易一一证明． 由于行列式的绝对值表示体积% 链接未完成
， 我们也可以从几何上理解这些定理．
...
行列式的代数性质可以抽象为\textbf{外代数}（见\autoref{AlgFie_ex1}~\upref{AlgFie} 以及例子后的解释），进而用于定义\textbf{外微分}\upref{ExtDif}，描述微分形式的代数性质．
