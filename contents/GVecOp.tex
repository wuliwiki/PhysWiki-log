...
\begin{figure}[ht]
\centering
\includegraphics[width=10.5cm]{./figures/9f9c373edaf54d09.pdf}
...
\subsection{矢量的数乘、共线、逆矢量、归一化}\label{sub_GVecOp_1}
第二个矢量运算，是一个矢量和一个数字的乘积，得到一个矢量，称为数乘，我们用例子定义如下。

\begin{figure}[ht]
\centering
\includegraphics[width=9cm]{./figures/915bbc1a9564a850.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=4.5cm]{./figures/ec4085be675c0cbd.pdf}
