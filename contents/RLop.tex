...
\pentry{量子力学的算符和本征问题\upref{QM1}}{nod_c605}

\subsection{概念}


有时候如果算符过于复杂，求解本征方程比较困难，就可以尝试寻找升降算符。升降算符可以让我们不用求解本征方程就可以快速地找到本征值。可参见\textbf{量子简谐振子（升降算符法）}\upref{QSHOop}和轨道角动量\upref{QOrbAM}。
...
\begin{equation}\label{eq_RLop_1}
\begin{aligned}
...
\subsection{升降算符的矩阵形式}\label{sub_RLop_1}
