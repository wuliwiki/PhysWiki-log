...
\pentry{反正切函数}{nod_d387}

我们经常会遇到这样一个问题： 已知平面直角坐标系上一点 $P$， 坐标为 $(x, y)$， 求射线 $OP$ 与 $x$ 轴正方向的夹角 $\theta$。% \addTODO{图}
...
\subsection{偏导数}
\pentry{偏导数\nref{nod_ParDer}}{nod_366d}
函数在除了在原点和 $x$ 轴的负半轴， 在其它定义域都是连续且光滑的， 即存在连续的无穷阶\enref{偏导}{ParDer}。 一阶偏导为
\begin{equation}
