...
其中
\begin{equation}
\theta_l(\eta, \rho) = \rho - \eta\ln(2\rho) - \frac{l\pi}{2} + \sigma_l(\eta)
\end{equation}
...
\begin{equation}
\int_0^\infty F_l(Z/k', k' r)F_l(Z/k, kr) \dd{r} = \int_0^\infty \sin(k'r)\sin(kr) \dd{r} = \frac{\pi}{2}[\delta(k - k') - \delta(k + k')]
\end{equation}