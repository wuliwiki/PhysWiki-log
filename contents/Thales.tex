...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/67abfb4036bad80a.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/7b824ff7ad566880.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/8c810c63522f09e8.png}
...
\subsection{注释}  
\begin{enumerate}
\item Heath, Thomas L. (1956). *The Thirteen Books of Euclid's Elements*. 第2卷（第3–9卷）（第2版）。Dover，第61页。ISBN 0486600890。最初由剑桥大学出版社出版，第一版1908年，第二版1926年。  
\item de Laet, Siegfried J. (1996). *History of Humanity: Scientific and Cultural Development*. 联合国教科文组织，第3卷，第14页。ISBN 92-3-102812-X  
\item Dicks, D. R. (1959). "Thales". *The Classical Quarterly*. 9 (2): 294–309. doi:10.1017/S0009838800041586.  
\item Allen, G. Donald (2000). "Thales of Miletus" (PDF)。检索于2012-02-12。  
\item Patronis, Tasos; Patsopoulos, Dimitris (2006年1月). "The Theorem of Thales: A Study of the Naming of Theorems in School Geometry Textbooks". *The International Journal for the History of Mathematics Education*: 57–68. ISSN 1932-8826。2013-11-05归档。  
\item Sidoli, Nathan (2018). "Greek mathematics" (PDF)。在Jones, A.; Taub, L.（主编）。*The Cambridge History of Science: Vol. 1, Ancient Science*。剑桥大学出版社，第345–373页。  
\item *Resources for Teaching Mathematics*: 14–16 Colin Foster 
\end{enumerate} 
\subsection{参考文献}  
\begin{itemize}
\item Agricola, Ilka; Friedrich, Thomas (2008). *Elementary Geometry*. AMS，第50页。ISBN 978-0-8218-4347-5.  
\item Heath, T.L. (1921). *A History of Greek Mathematics: From Thales to Euclid*. 第1卷。牛津，第131页及以下。
\end{itemize}
\subsection{外部链接}  
\begin{itemize}
\item Weisstein, Eric W. "Thales' Theorem". *MathWorld*.  
\item *Munching on Inscribed Angles*  
\item 塔勒斯定理解释，带有互动动画  
\item 由Michael Schreiber提供的塔勒斯定理演示，*Wolfram Demonstrations Project*
\end{itemize}