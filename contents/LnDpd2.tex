...
对于一组向量$\alpha_1, \alpha_2,\alpha_3,...$，若\textbf{存在不全为0的}$k_1,k_2,...$，使$k_1 \bvec \alpha_1+k_2 \bvec \alpha_2+k_3 \bvec \alpha_3+...=0$，即称$\alpha_1, \alpha_2,\alpha_3,...$ \enref{线性相关}{linDpe}。
