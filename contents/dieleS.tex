...
\end{equation}
其中常数 $\chi$ 叫做\textbf{电极化率（electric susceptibility）}， $\epsilon_0$ 是真空中的电容率。 % \addTODO{链接}
特殊地， 我们可以认为真空也是一种极化率为零的电介质。

若电介质不满足上述三个条件， 在最一般的情况下， 电极化率可以用一个 $3\times 3$ 的矩阵 $\bvec \chi$ 表示， 称为\textbf{电极化张量}。 % \addTODO{这个名字不确定。}
