...
\pentry{变分的变换\nref{nod_VarCha}}{nod_9bcf}
本节给出的两个定理，将有助于引出欧拉方程。其中一个定理属于拉格朗日，另一个属于黎曼。由拉格朗日推演的欧拉方程是不精确的，这可从\enref{拉格朗日变换}{VarCha}的定义中看到。而由黎曼推演可精确的推出欧拉方程，并且得到在极值曲线的正规点上，$y''$ 存在，而这是事先并未假定的。本节将证明推演欧拉方程用到的这两个定理。
