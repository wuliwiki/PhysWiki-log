...
\pentry{自由度\upref{DoF}， 动量定理\upref{PLaw}，质心、质心系\upref{CM}}{nod_a67c}

我们现在考虑两个仅受相互作用的质点 $A$ 和 $B$， 它们的质量分别为 $m_A$ 和 $m_B$。 由于不受系统外力， 在任何惯性系\upref{New3}中它们的质心\upref{CM}都会做匀速直线运动（\autoref{eq_PLaw_2}~\upref{PLaw}）。 所以系统的质心参考系（\autoref{sub_CM_2}~\upref{CM}）是一个惯性系， 以下我们选取质心参考系， 系统的质心将一直处于原点。
...
在质心系中观察， 两质点的位矢 $\bvec r_A$ 和 $\bvec r_B$ 满足（\autoref{eq_CM_7}~\upref{CM}）
