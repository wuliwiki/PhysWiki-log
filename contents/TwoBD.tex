...
我们现在考虑两个仅受相互作用的质点 $A$ 和 $B$， 它们的质量分别为 $m_A$ 和 $m_B$。 由于不受系统外力， 在任何惯性系中它们的质心\upref{CM}都会做匀速直线运动（\autoref{PLaw_eq2}~\upref{PLaw}）。 所以系统的质心参考系是一个惯性系， 以下我们选取质心参考系， 系统的质心将一直处于原点。
...
解：两天体之间的引力大小为（\autoref{Gravty_eq1}~\upref{Gravty}）
\begin{equation}
F = \frac{Gm_1m_2}{R^2}~.
\end{equation}
如果不使用等效质点的概念， 我们可以先用\autoref{TwoBD_eq3} 得到两个天体做圆周运动的半径， 然后再令引力等于其中一个天体的向心力\upref{CentrF}
\begin{equation}
F = m_1 \omega^2 r_1~.
\end{equation}
