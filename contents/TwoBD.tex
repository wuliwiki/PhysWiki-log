...
\end{equation}
且定义\bb{相对速度}和\bb{相对加速度}分别为 $\bvec R$ 的导数 $\dot{\bvec R}$ 和二阶导数 $\ddot{\bvec R}$．
...
\end{equation}
也就是说， 在质心系中使用相对位矢， 二体系统的运动规律就相当于单个质量为 $\mu$， 位矢为 $\bvec R$ 的质点的运动规律， 我们姑且将其称为\bb{等效质点}． 而 $A$ 对 $B$ 的作用力可以看成等效质点的受力．
