% 测地线
% keys geodesic|联络|直线|匀速直线运动|相对论|流形|manifold|connection|Christoffel 符号|测地线方程
% license Xiao
% type Tutor

\pentry{Christoffel符号\upref{CrstfS}，协变导数\upref{CoDer}}{nod_5a25}
...
\autoref{eq_geodes_1} 是一个欧几里得空间中的常微分方程。由常微分方程中解的存在与唯一性定理可得如下定理。
...
我们只需要证明，测地线方程满足定理中所给拉格朗日函数的\textbf{欧拉—拉格朗日方程}\upref{Lagrng}。
...
将\autoref{eq_CrstfS_3}~\upref{CrstfS}誊抄如下：
\begin{equation}
