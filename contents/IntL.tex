...
\pentry{功\ 功率\upref{Fwork}}

在“功\ 功率\upref{Fwork}”中，我们大致了解了线积分 $\int_{C_{ab}} \bvec F(\bvec r) \vdot \dd{\bvec r} $ 的意义．下面讨论如何在直角坐标系中具体计算线积分．为书写方便，以下省略积分路径 $C_{ab}$． 
...
\begin{example}{计算力场对质点的做功}\label{IntL_ex1}
...
在上例中， 我们发现对于给定的矢量场， 即使路径不同，当起点和终点相同时， 线积分的结果也相同（虽然我们只计算了两条路径， 但这个结论是正确的）． 具有这样性质的矢量场叫做\bb{保守场}，并总存在一个势能函数． 
