% 静电边值条件与唯一性定理
% 静电边值条件|唯一性定理|电势的泊松方程

\pentry{静电势的泊松方程\upref{EPoiEQ}，矢量算符运算法则\upref{VopEq}}

在静电势的泊松方程\upref{EPoiEQ}中我们已经求出了一般静电学问题中，电势所满足的泊松方程（\autoref{EPoiEQ_eq1}~\upref{EPoiEQ}）
\begin{align}
