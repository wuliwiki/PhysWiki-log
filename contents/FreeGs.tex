...
\pentry{一维自由高斯波包（量子）\upref{GausWP}， Matlab 画图\upref{MatPlt}}

以下代码绘制自由粒子的高斯波包（\autoref{GausWP_eq4}~\upref{GausWP}）的动画． 代码将生成 \verb|Nt| 张图片， 可以由 “用 Matlab 制作 gif 动画\upref{MatGif}” 中的代码制作 gif 动图．

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/FreeGs_1.png}
\caption{运行结果， 动画见\href{https://wuli.wiki/apps/free_gauss.html}{这里}．} \label{FreeGs_fig1}
\end{figure}
