...
以下代码绘制自由粒子的高斯波包（\autoref{eq_GausWP_4}~\upref{GausWP}）的动画。 代码将生成 \verb|Nt| 张图片， 可以由 “用 Matlab 制作 gif 动画\upref{MatGif}” 中的代码制作 gif 动图。

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/6076ad736a786009.png}
