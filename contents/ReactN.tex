...
\item 本地开发环境一般是 \enref{Node.JS}{NodeJS} + VS code + Chrome Dev Tool
...
\item \verb`npm install ...` 会在当前文件夹安装某个包到 \verb`node_modules`， 并写入 \verb`package*.json` 文件。 如果要直接安装到操作系统，就用 \verb`npm -g install ...`
...
\subsection{第一个表格显示数据库 App}
见 \href{https://github.com/MacroUniverse/React_test}{React_test/x-data-grid}
