...
我们在高中物理学过， 闭合线圈产生的感生电动势 % \addTODO{链接}
...
\end{equation}
这里的路径积分是沿着线圈进行的。 规定线圈正方向以后， \autoref{eq_FaraEB_1} 中曲面的正方向由\enref{右手定则}{RHRul}决定。

根据麦克斯韦方程组， 电场产生的原因有两种， 一种是电荷产生电场（\enref{电场的高斯定律}{EGauss}），另一种是变化的磁场产生电场（法拉第电磁感应）。 前者在\autoref{eq_FaraEB_2} 中的环路积分为零， 对电动势没有贡献。 所以\autoref{eq_FaraEB_2} 中的 $\bvec E$ 既可以只包含感生电场， 也可以是总电场。 我们一般理解为总电场。
