...
Matlab 代码如下， 使用\autoref{eq_CraNic_5}， 以及 Matlab 的稀疏矩阵\upref{MatSpa}。 势能函数可以在 \verb|V_fun| 中设置， 我们以方势垒为例， 所有参数和 “高斯波包的方势垒散射数值计算（Matlab）\upref{FSBsct}” 相同。 不同的是， 由于我们使用迪利克雷边界条件， 波函数到达边界后会发生全反射。 要避免反射， 可以用开放边界条件%\addTODO{}
以及吸收势能。%\addTODO{}
