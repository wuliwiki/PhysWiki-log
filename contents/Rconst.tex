% 旋转参考系的 “机械能守恒”
% keys 机械能守恒|旋转参考系|势能|雅可比常量
% license Xiao
% type Tutor

\pentry{科里奥利力\nref{nod_Corio}， 机械能守恒（单个质点）\nref{nod_ECnst}}{nod_7ab6}

在匀速旋转参考系中， 如果加入惯性力的修正， 则牛顿定律同样适用。 那么我们是否同样有某种 “修正版” 的单质点机械能守恒呢？ 答案是肯定的， 在旋转参考系中， 我们仍然定义每个质点的动能为 $E_k = mv^2/2$ （$v$ 是相对旋转参考系的速度）， 假设质点所受的所有非惯性力在旋转参考系中都是\enref{保守力}{V}， 对应的势能函数 $V(\bvec r)$。 那么机械能修正后的守恒量为
...
例子： \enref{雅可比常量}{JacCon}。

\subsection{推导}
证明的思路很简单， 在 “\enref{机械能守恒（单个质点）}{ECnst}”中证明的基础上， 我们只需要额外考虑惯性力的做功即可。
...
\end{equation}
 这是一个中心力场， 所以必定是一个\enref{保守场}{CenFrc}， 沿径向积分容易得到对应的等效势能函数为
\begin{equation}
