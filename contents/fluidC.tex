...
\pentry{流体运动的描述方法\nref{nod_fluid1}，物质导数（实质导数）\nref{nod_fluid2}，重积分、面积分、体积分（简明微积分）\nref{nod_IntN}}{nod_c45a}
...
如果将应力张量的表达式\autoref{eq_NSeq_1}~\upref{NSeq} 代入，并利用\enref{热传导定律}{Heatco}将 $\bvec q$ 表达为 $-k\nabla T$，上述方程可以改写为
