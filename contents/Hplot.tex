...
\pentry{类氢原子的定态波函数\upref{HWF}， Matlab 画图\upref{MatPlt}}{nod_38fa}

这里给出\autoref{fig_HWF_2}~\upref{HWF} 的画图程序。 需要 \verb|SphHarm| 函数\upref{YlmNum}。 以及 \verb|surfSph| 函数\upref{MatPol}。
