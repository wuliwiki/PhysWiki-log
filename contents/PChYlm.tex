...
\end{equation}
根据\autoref{SphHar_eq10}~\upref{SphHar}， 令 $\alpha$ 为 $\uvec r, \uvec r'$ 的夹角， 上式也可以记为
...
\begin{figure}[ht]
\centering
\includegraphics[width=14.2cm]{./figures/PChYlm_1.png}
...
\subsection{附： 画图代码}
\autoref{PChYlm_fig1} 的 Matlab 代码如下， 其中 \verb|surfSph| 函数见 “Matlab 球坐标中的分布图\upref{MatPol}”． \verb|SphHarm| 函数见 “球谐函数数值计算\upref{YlmNum}”．
