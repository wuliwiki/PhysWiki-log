% 位移电流、安培—麦克斯韦公式
% keys 位移电流|麦克斯韦修正|麦克斯韦方程组|安培环路定理|旋度|散度
% license Xiao
% type Tutor
...
\pentry{安培环路定律\nref{nod_AmpLaw}，法拉第电磁感应定律\nref{nod_FaraEB}}{nod_bdab}

\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Displacement_current}{相关页面}。}在\enref{法拉第电磁感应定律}{FaraEB}中，我们已经知道了“变化的磁场会产生电场”；那么反过来，“变化的电场也会产生磁场”吗？充满着简洁与对称美的电动力学给出了肯定的答案。

\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/e1c6dad9a3e6b548.pdf}
\caption{“变化的电场产生磁场”示意图} \label{fig_DisCur_1}
\end{figure}

为了体现“变化的电场也会产生磁场”，我们必须在静电学的\enref{安培环路定律}{AmpLaw}补充一项，使之由
\begin{equation}
...
根据\enref{斯托克斯定理}{Stokes}，还可将其写为微分形式
...
\end{equation}
这就是说，和\enref{法拉第电磁感应}{FaraEB}相似，变化的电场也会产生磁场， 并且和电流产生的磁场叠加得到总磁场。 该式称为\textbf{广义安培环路定律}或者\textbf{麦克斯韦—安培公式}。
