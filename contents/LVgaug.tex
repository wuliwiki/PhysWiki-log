...
\footnote{本文参考 \cite{Bransden}。}本文使用\enref{原子单位制}{AU}。 和长度规范中的思路一样， 我们只在使用偶极子近似\upref{DipApr}时讨论\textbf{速度规范（velocity gauge）}。 用角标 $V$ 表示速度规范， 先从规范不变的哈密顿算符（\autoref{eq_QMEM_1}~\upref{QMEM}）出发
