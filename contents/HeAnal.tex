...
\subsection{径向概率分布}
\begin{equation}
P(r_1, r_2) = \iint \abs{\Psi(\bvec r_1, \bvec r_2)}^2 r_1^2 r_2^2 \dd{\Omega_1}\dd{\Omega_2}
\end{equation}
...
单电子概率为
\begin{equation}
P(\bvec r_1) = 2\sum_{l_2, m_2} \int \abs{\psi_{l_2, m_2}(r_2)}^2 \dd{r_2} = \frac{2}{r_1^2} \sum_{l_2, m_2} \int \abs{\sum_{l_1, m_1} \psi_{l_1, l_2}^{m_1, m_2}(r_1, r_2) Y_{l_1,m_1}(\uvec r_1)}^2 \dd{r_2}
\end{equation}
