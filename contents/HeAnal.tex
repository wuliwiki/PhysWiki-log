...
\begin{equation}
\begin{aligned}
&P_{n_1,l_2}(\bvec r_2) = \int \abs{\Psi_{n_1,l_1}(\bvec r_1, \bvec r_2)}^2 \dd[3]{r_1}
...
\ev{r_2}_{n_1,l_1,\uvec r_2} = \frac{\int r_2 P_{n_1,l_2}(\bvec r_2) r_2^2 \dd{r_2}}{\int P_{n_1,l_2}(\bvec r_2) r_2^2 \dd{r_2}}
