...
\pentry{Python 虚拟环境 venv 笔记\nref{nod_PyVenv}}{nod_551a}
...
\item Django 主要用于后端（虽然提供少量前端支持）， 前端可以用 \enref{React}{ReactN}， Vue 等框架实现。
...
\item 【可选】\enref{创建虚拟环境}{PyVenv} \verb|python3 -m venv env|， 然后 \verb|source env/bin/activate| 开启虚拟环境
