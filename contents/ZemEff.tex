% 塞曼效应
% keys 赛曼效应|精细结构|磁矩|轨道角动量|氢原子
% license Xiao
% type Tutor

\pentry{氢原子的精细能级结构\nref{nod_HfineS}， Clebsch–Gordan 系数\nref{nod_SphCup}}{nod_8b88}
...
\end{equation}
方向 $z$ 是磁场 $B$ 的方向，我们先来处理轨道角动量 $\mathbf{L}$ 的量子化，详情请见\enref{轨道角动量升降算符归一化}{QLNorm}。首先，我们先来定义之前在谐振子问题就用到过的升降阶算符的方法，见\enref{简谐振子升降算符归一化}{QSHOnr}。
\begin{equation}
