...
实数集的任何非空有界子集，必有一个实数上确界（\enref{见上确界与下确界}{SupInf}）。
\end{theorem}
...
每个定理，或者说公理，都从各自的角度刻画了“实数不存在缝隙”这一性质。它们都和\enref{完备公理（戴德金分割）}{Cmplt}中的\autoref{the_Cmplt_1}~\upref{Cmplt}等价。
...
\begin{exercise}{}
使用本节以及\enref{完备公理（戴德金分割）}{Cmplt}中介绍的八条公理，证明 $0.\dot{9}=1$。注意 $0.\dot{9}$ 被4定义为数列 $\{0.9, 0.99, 0.999, 0.9999\cdots\}$ 的极限。
\end{exercise}
