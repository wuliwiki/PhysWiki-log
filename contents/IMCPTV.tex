...
\pentry{相简介（热力学）\nref{nod_PHS}， 理想气体混合的熵变\nref{nod_IGME}}{nod_17c8}
\begin{figure}[ht]
\centering
...
实际的混合是一个复杂的过程，往往伴随着熵的改变（我们已经在\enref{理想气体混合}{IGME}中探讨了一些）、体积的改变、能量的改变等等等等。
...
\end{figure}
由于\enref{Gibbs自由能}{GibbsG}与熵有关，因此Gibbs能的表达也会复杂一些。直接根据Gibbs能的定义：
$$
\begin{aligned}
...
\mu_i = \mu_i^* + RT \ln (x_i)~,
$$
反映了混合物中各组分的化学势$\mu_i$与相应纯物质化学势$\mu_i^*$的关系。%化学势需要建立一个更好的文章
