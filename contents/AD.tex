...
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/f7364c47be832776.png}
\caption{操作 $1$} \label{fig_AD_1}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=13cm]{./figures/f44c7c821219e7eb.png}
\caption{操作 $2$} \label{fig_AD_2}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/4fc5ca7a440c0311.png}
