...
\subsection{动力学方程}
三体系统在空间中\enref{自由度}{DoF}为9，但由于天体A和B的运动模式已知，故限制性三体系统的自由度为3，可用质点C在旋转坐标系中的广义坐标 $x$,$y$,$z$ 描述。将质点C的动能 $T$（\autoref{eq_TriLim_3}）和势能 $U$（\autoref{eq_TriLim_4}）代入\enref{拉格朗日方程}{Lagrng}）
\begin{equation}%1
