...
根据\autoref{eq_SelRul_1}~\upref{SelRul} 可以用 3j 系数表示角向积分，进而化简为\autoref{eq_HyTDSE_11}~\upref{HyTDSE}
\begin{equation}
...
% hydrogen polarizability of good eigen states
function d_z = h_dipole_z
% === params ===
Z = 1;
m = 0;
% ==============
...
for n1 = 1:4
    for l1 = 0:n1-1
        ...
        for n2 = 1:4
            for l2 = 0:n2-1
                k2 = k2 + 1;
                d_z(k1,k2) = h_dipole_z1(Z,n1,l1,n2,l2,m);
            end
        end
    end
end
...
function d_z = h_dipole_z1(Z,n1,l1,n2,l2,m)
if (abs(l1-l2) ~= 1)
    d_z = 0; return;
end
...
% radial integral
I_r = integral(integrand, 0, inf);
% angular integral
I_th = (-1)^m * sqrt((2*l1+1)*(2*l2+1)) ...
    * ThreeJ(l1,0,1,0,l2,0) * ThreeJ(l1,-m,1,0,l2,m);
d_z = I_r * I_th;
end
\end{lstlisting}
