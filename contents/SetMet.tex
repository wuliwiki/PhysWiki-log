...
\pentry{集合\upref{Set}，微积分或数学分析}{nod_7a95}
...
\pentry{黎曼积分与勒贝格积分\upref{Rieman}}{nod_3b55}
...
最后，我们要再讨论一个引理，在下一节\textbf{可测集合}\upref{MsbSet}中会很有用。
...
但是由\textbf{集合的极限}\upref{SetLim}可知，$A_0=\lim\limits_{i\to\infty} A_i$，因此使得 $A_i\cap S=\varnothing$ 恒成立的 $S$ 必须是空集 $\varnothing$，而这和 $\opn{m^*}S=x_0>0$ 矛盾。
