...
\subsubsection{定积分的基本运算性质}
每一本高数教材\cite{同济高}\cite{Thomas}都会列出一张长长的定积分运算律的表格．这里只列举一些其中的一些．这些定理尽管看起来都\textsl{非常显然}，但在实际做题时往往会带给初学者不少困惑．
\begin{itemize}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/DefInt_2.png}
