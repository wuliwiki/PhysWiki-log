...
\pentry{理想气体分压定律\nref{nod_PartiP}， 熵的宏观表达式\nref{nod_MacroS}}{nod_e2fb}
...
尽管移除挡板后系统的总压强还是$p$，但$A, B$各自的\enref{分压}{PartiP}却降低了。例如，$A$气体的分压从混合前的$p$降为$p'=p \cdot x_A$。

先计算$A$气体的熵变。根据\enref{熵的计算公式}{MacroS}，此时
$$
