...
\end{equation}
用 $r = \sqrt{x^2+y^2}$ 以及 $\bvec r = x\uvec x + y\uvec y$， 其中 $x,y$ 看成 $t$ 的函数． 考虑到 $a_x = \dv*[2]{x}{t}$， $a_y = \dv*[2]{y}{t}$， 可以列出二阶微分方程组
...
程序运行结果如\autoref{KPNum0_fig1} 所示． 注意行星轨道并不是一个闭合的椭圆， 这是由于这种算法误差较大， 为了减小误差， 可以增加程序中\lstinline|Nstep| 的值．
\begin{figure}[ht]
\centering
