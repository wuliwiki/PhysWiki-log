...
假设已知初值条件 $x(0) = x_0$， $y(0) = y_0$， $\dot x(0) = v_{x0}$， $\dot y(0) = v_{y0}$． 下面用“簧振子受迫振动的简单数值计算\upref{SHOFN}” 中类似的方法求接下来行星的运动轨迹．
...
\qquad
\leftgroup{
x(\Delta t) \approx \dot x(0)\Delta t + x(0)\\ y(\Delta t) \approx \dot y(0)\Delta t + y(0)}
\end{equation}
