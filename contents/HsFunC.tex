...
\begin{theorem}{零点存在定理}\label{the_HsFunC_1}
...
\begin{definition}{斜率}\label{def_HsFunC_5}
...
\begin{definition}{最值}\label{def_HsFunC_4}
...
\begin{definition}{奇偶性}\label{def_HsFunC_7}
...
\begin{definition}{周期}\label{def_HsFunC_6}
...
\subsection{特殊的函数}\label{sub_HsFunC_5}
