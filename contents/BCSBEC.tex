...
\end{equation}
而我们知道， \autoref{eq_TwoAtF_38}~\upref{TwoAtF} 给出了
\begin{equation}
...
&=\frac{1}{V}\sum_{\bvec k}\left(1-\frac{\epsilon_x{\Delta}}{E_x{\Delta}}\right)\\ % \addTODO{这里分子分母两个 delta 是被 \cancel 掉的， 然而这个命令编译不出来}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/6b75543ffd5e0195.png}
