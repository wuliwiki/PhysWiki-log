...
显然，这和\textbf{真正的求}导不同。一方面我们没有在域$\mathbb{Z}_3$上定义极限的概念，另一方面实数域上$f$的导函数应该是$5x^4+4x-1$。
\end{example}
...
2. 当$\opn{ch}\mathbb{F}=0$\footnote{概念见\autoref{def_field_2} . }时，对于$f\in\mathbb{F}[x]$有：$\opn{D}f=0 \iff \opn{de\begin{equation}
\begin{align}
