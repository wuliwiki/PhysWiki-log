...
\addTODO{内容与\enref{可分扩张}{SprbEx}重复，该文章应删除。}
...
一般来说，\autoref{ex_CmplD_1} 中的$\mathbb{Z}_2$替换为任意素域$\mathbb{Z}_p$、$x^2-t$也替换为$x^p-t$后，结论依然成立。感兴趣的读者可自行验证这一点。其中，证明$x^p-t$不可约，可以使用整环上的\enref{爱森斯坦判别式}{EsstCr}。
