...
相互作用 Hamiltonian，我们考虑一个坐标表象直积一个 open-closed 的 channel 表象． 这种情况下，可以写为：
\begin{equation}
...
考虑在 $r\ge r_0$ 的位置，体系波函数就不再会包含close成分，也就是说， $\langle\text{close}|\Psi\rangle(r_0) = 0$，从而告诉我们这个系数 $A$ 满足
\begin{equation}
