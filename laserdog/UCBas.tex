...
，得到了一个Zeeman \text{eff}ect的二次shift。而大的磁场下超精细结构 $A_1, A_2$ 很小，几乎忽略，主要修正项都是 $\frac{\sqrt{3}}{2}\Delta\mu B$，是线性的Zeeman shift。
...
因为这里我们实际上扔了一个算符进去，并不应该写成这样子，而应该写成一个{\color{red}{仅}}对基态有用的有效Hamiltonian：
