...
\end{equation}
上面四个矩阵被称为 \bb{Pauli 矩阵}，有的时候也会写成四维（矩阵）矢量的形式，$\vec{\bm\sigma}$．
...
\begin{figure}[ht]
\centering
\includegraphics[width=8.7cm]{./figures/Basics.pdf}
