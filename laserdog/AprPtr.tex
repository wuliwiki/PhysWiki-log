...
\begin{split}
H &= H_0+H_{int},\\
H_0 &= \sum_{\vec k}\hbar\omega_{\vec k}a^\dagger_{\vec k}a_{\vec k} + \frac{1}{2}\hbar\omega_{eg}\sigma_z,\\
H_{int} &= \hbar\sum_{\vec k} \Omega_{\vec k}\sigma_+ a_{\vec k} \E^{\I\vec k\cdot r} + \Omega_{\vec k}^*\sigma_- a_{\vec k}^\dagger \E^{-\I\vec k\cdot r} .
\end{split}
\end{align}
...
\begin{equation}\ali{
&\E^{\I\omega_{\vec k}a^\dagger_{\vec k}a_{\vec k}t}a_{\vec k} \E^{-\I\omega_{\vec k}a^\dagger_{\vec k}a_{\vec k}t} = a_{\vec k} \E^{-\I\omega_{\vec k}t}\\
