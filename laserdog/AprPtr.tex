...
那么，在经过 $U$ 变换的坐标系中（$|g\rangle,|e\rangle$是完整的Hamiltonian的本征态），$|\psi(t=0)\rangle = \frac{1}{A}|g\rangle + \frac{1}{B}|e\rangle$，一切都变得简单了起来． $|\psi(t)\rangle = \E^{-\lambda_-t/\hbar}\frac{1}{A}|g\rangle + \E^{-\lambda_+t/\hbar}\frac{1}{B}|e\rangle$，其中必然有 $\frac{1}{A^2} + \frac{1}{B^2} = 1$（这个验算可能会比较繁琐，Mathematica结果见\autoref{AprPtr_fig1}）
