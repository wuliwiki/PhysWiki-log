...
\begin{equation}
\begin{aligned}
\ev{n_i} & = \frac{1}{\Xi }\sum_{n_i=0}^1 {n_i}{{\left[ {\E^{(\mu - \varepsilon_i)\beta}} \right]}^{n_i}} = \frac{0 + \E^{(\mu - \varepsilon_i)\beta }}{1 + \E^{(\mu - \varepsilon_i)\beta}}  = \frac{1}{\E^{(\varepsilon_i - \mu)\beta} + 1}
\end{aligned}
\end{equation}
这就是著名的\bb{费米—狄拉克分布}．
