...
\begin{equation}
(-\frac 12) ! = \int_0^{+\infty} \frac{\E^{-x}}{\sqrt x}\dd{x} = \sqrt{\pi}
\end{equation}
该积分的计算超出本书范围，可使用 Wolfram Alpha 或 Mathematica 计算．%未完成
对任意大于零的半整数 $n/2$，有
\begin{equation}
\frac{n}{2}! = \frac{n}{2} \qty(\frac{n}{2}-1)! = \frac{n}{2} \qty(\frac{n}{2}-1) \dots \frac12 \qty(-\frac 12) ! = \frac{n}{2} \qty(\frac{n}{2}-1) \dots \frac12 \sqrt{\pi}
\end{equation}
