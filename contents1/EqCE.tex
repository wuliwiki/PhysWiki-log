...
\begin{equation}
\expval{\varepsilon} = \left. \frac{\varepsilon \E^{-\varepsilon/\tau}}{(1 - \E^{-\varepsilon/\tau})^2} \middle/ \frac{1}{1 - \E^{-\varepsilon/\tau}}  \right. = \frac{\varepsilon \E^{-\varepsilon/\tau}}{1 - \E^{-\varepsilon/\tau}} = \frac{\varepsilon}{\E^{\varepsilon/\tau} - 1}
\end{equation}
...
我们也可以直接用能量均值公式
\begin{equation}
\expval{\varepsilon} = -\pdv{\beta} \ln Q
