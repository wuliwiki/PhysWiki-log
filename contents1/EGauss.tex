...
\oint {\vec E \vdot \D \vec s}  = \frac{1}{{{\epsilon _0}}}\int {\rho  \D V} 
\end{equation} 
其中常数 ${\epsilon _0}$ 为\bb{真空中的电介质常数}，又叫\bb{真空中的电容率}．
为了便于理解和记忆，可以把电场想像成某种流体的场，这种流体从正电荷流出，流入负电荷，流出和流入的速率（单位时间的体积）和电荷的大小成正比，比例系数为 $1/{\epsilon _0}$． 从数学上来讲，有电荷的地方电场就有\bb{源}， $\rho /{\epsilon _0}$ 就叫做电场的\bb{源密度}． 高斯定理的证明见下文．
