...
&\exp\left[\frac{-(x - p_0 t/m)^2}{(2\sigma )^2 (1 + \I\hbar t/2m \sigma^2)}\right] \exp\left[\frac{\I p_0}{\hbar } \qty(x - \frac{p_0 t}{2m})\right]
\end{aligned}\end{equation}
若令 $\hbar  = 1$， 且定义无量纲参数 $x' = x/\sigma$， $k' = \sigma k$， $t' = t/m\sigma^2$． 则上式可记为（省略撇号）
\begin{equation}
\psi (x,t) = \frac{1}{(2\pi\sigma^2)^{1/4}} \frac{1}{\sqrt{1 + \I t}} \exp\left[\frac{-(x - k_0 t)^2}{2(1 + \I t)}\right] \exp[\I k_0(x - k_0 t)]
\end{equation}
