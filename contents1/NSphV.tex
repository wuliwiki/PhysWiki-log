...
\end{equation}
再代入\autoref{NSphV_eq2}， 得二维求的体积为（注意 $ -R_2 < x_2 < R_2$ ）
...
\end{equation}
在几何意义上，这是说把求沿 $x_1 x_2$ 平面切成许多二维球（圆），然后把求的体积（面积）沿 $x_3$ 轴积分．由 $x_1^2 + x_2^2 \les R_3^2 - x_3^2$， 得 $x_3$ 处二维球半径为 $R_2 = (R_3^2 - x_3^2)^{1/2}$． 由\autoref{NSphV_eq4} 得体积为
